!function(e) {
    ...
    else { ("undefined" != typeof window ? window: "undefined" != typeof global ? global: "undefined" != typeof self ? self: this).Terminal = e()
    }
} (function() {
    return function s(o, a, l) {
        ...
        1 : [function(e, t, i) {
            ...
            c = function(r) {
                function e(e) {
                    ...
                    t._rowElements = [];
                    for (var i = 0; i < t._terminal.rows; i++) t._rowElements[i] = t._createAccessibilityTreeNode(),
                    t._rowContainer.appendChild(t._rowElements[i]);
                    return t._topBoundaryFocusListener = function(e) {
                        return t._onBoundaryFocus(e, 0)
                    },
                    t._bottomBoundaryFocusListener = function(e) {
                        return t._onBoundaryFocus(e, 1)
                    },
                    t._rowElements[0].addEventListener("focus", t._topBoundaryFocusListener),
                    t._rowElements[t._rowElements.length - 1].addEventListener("focus", t._bottomBoundaryFocusListener),
                    t._refreshRowsDimensions(),
                    t._accessibilityTreeRoot.appendChild(t._rowContainer),
                    t._renderRowsDebouncer = new o.RenderDebouncer(t._renderRows.bind(t)),
                    t._refreshRows(),
                    ...
                    t._terminal.element.insertAdjacentElement("afterbegin", t._accessibilityTreeRoot),
                    t.register(t._renderRowsDebouncer),
                    t.register(t._terminal.onResize(function(e) {
                        return t._onResize(e.rows)
                    })),
                    t.register(t._terminal.onRender(function(e) {
                        return t._refreshRows(e.start, e.end)
                    })),
                    t.register(t._terminal.onScroll(function() {
                        return t._refreshRows()
                    })),
                    t.register(t._terminal.addDisposableListener("a11y.char",
                    function(e) {
                        return t._onChar(e)
                    })),
                    t.register(t._terminal.onLineFeed(function() {
                        return t._onChar("\n")
                    })),
                    t.register(t._terminal.addDisposableListener("a11y.tab",
                    function(e) {
                        return t._onTab(e)
                    })),
                    t.register(t._terminal.onKey(function(e) {
                        return t._onKey(e.key)
                    })),
                    t.register(t._terminal.addDisposableListener("blur",
                    function() {
                        return t._clearLiveRegion()
                    })),
                    t.register(t._terminal.addDisposableListener("dprchange",
                    function() {
                        return t._refreshRowsDimensions()
                    })),
                    t.register(t._terminal.renderer.onCanvasResize(function() {
                        return t._refreshRowsDimensions()
                    })),
                    t.register(a.addDisposableDomListener(window, "resize",
                    function() {
                        return t._refreshRowsDimensions()
                    })),
                    t
                ...
                e.prototype._onResize = function(e) {
                    ...
                    for (var t = this._rowContainer.children.length; t < this._terminal.rows; t++) this._rowElements[t] = this._createAccessibilityTreeNode(),
                ...
                e.prototype._onChar = function(e) {
                    ...
                    if (this._liveRegionLineCount < 21) {
                        if (0 < this._charsToConsume.length) this._charsToConsume.shift() !== e && this._announceCharacter(e);
                        else this._announceCharacter(e);
                        "\n" === e && (this._liveRegionLineCount++, 21 === this._liveRegionLineCount && (this._liveRegion.textContent += l.tooMuchOutput)),
                ...
                e.prototype._renderRows = function(e, t) {
                    ...
                    r = i.lines.length.toString(), n = e; n <= t; n++) {
        ...
        2 : [function(e, t, H) {
            ...
            var i = e("./common/CircularList"),
            l = e("./BufferLine"),
            O = e("./BufferReflow"),
            s = e("./renderer/atlas/Types"),
            o = e("./common/EventEmitter2"),
            a = e("../lib/common/Lifecycle");
            H.DEFAULT_ATTR = 256 | s.DEFAULT_COLOR << 9,
            H.DEFAULT_ATTR_DATA = new l.AttributeData,
            ...
            var h = function() {
                function e(e, t) {
                    ...
                    this.markers = [],
                    this._nullCell = l.CellData.fromCharData([0, H.NULL_CELL_CHAR, H.NULL_CELL_WIDTH, H.NULL_CELL_CODE]),
                    this._whitespaceCell = l.CellData.fromCharData([0, H.WHITESPACE_CELL_CHAR, H.WHITESPACE_CELL_WIDTH, H.WHITESPACE_CELL_CODE]),
                    this._cols = this._terminal.cols,
                    this._rows = this._terminal.rows,
                    this.clear()
                }
                return e.prototype.getNullCell = function(e) {
                    return this._nullCell.bg = e ? (this._nullCell.fg = e.fg, e.bg) : this._nullCell.fg = 0,
                    this._nullCell
                },
                e.prototype.getWhitespaceCell = function(e) {
                    return this._whitespaceCell.bg = e ? (this._whitespaceCell.fg = e.fg, e.bg) : this._whitespaceCell.fg = 0,
                    this._whitespaceCell
                },
                e.prototype.getBlankLine = function(e, t) {
                    return new l.BufferLine(this._terminal.cols, this.getNullCell(e), t)
                },
                ...
                e.prototype._getCorrectBufferLength = function(e) {
                    ...
                    return t > H.MAX_BUFFER_SIZE ? H.MAX_BUFFER_SIZE: t
                },
                ...
                e.prototype.resize = function(e, t) {
                    ...
                    if (r > this.lines.maxLength && (this.lines.maxLength = r), 0 < this.lines.length) {
                        if (this._cols < e) for (var n = 0; n < this.lines.length; n++) this.lines.get(n).resize(e, i);
                        var s = 0;
                        if (this._rows < t) for (var o = this._rows; o < t; o++) this.lines.length < t + this.ybase && (0 < this.ybase && this.lines.length <= this.ybase + this.y + s + 1 ? (this.ybase--, s++, 0 < this.ydisp && this.ydisp--) : this.lines.push(new l.BufferLine(e, i)));
                        else for (o = this._rows; t < o; o--) this.lines.length > t + this.ybase && (this.lines.length > this.ybase + this.y + 1 ? this.lines.pop() : (this.ybase++, this.ydisp++));
                        if (r < this.lines.maxLength) {
                            var a = this.lines.length - r;
                            0 < a && (this.lines.trimStart(a), this.ybase = Math.max(this.ybase - a, 0), this.ydisp = Math.max(this.ydisp - a, 0)),
                    ...
                    if (this.scrollBottom = t - 1, this._isReflowEnabled && (this._reflow(e, t), this._cols > e)) for (n = 0; n < this.lines.length; n++) this.lines.get(n).resize(e, i);
                    this._cols = e,
                    this._rows = t
                },
                ...
                e.prototype._reflowLarger = function(e, t) {
                    var i = O.reflowLargerGetLinesToRemove(this.lines, this._cols, e, this.ybase + this.y, this.getNullCell(H.DEFAULT_ATTR_DATA));
                    if (0 < i.length) {
                ...
                e.prototype._reflowLargerAdjustViewport = function(e, t, i) {
                    for (var r = this.getNullCell(H.DEFAULT_ATTR_DATA), n = i; 0 < n--;) 0 === this.ybase ? (0 < this.y && this.y--, this.lines.length < t && this.lines.push(new l.BufferLine(e, r))) : (this.ydisp === this.ybase && this.ydisp--, this.ybase--)
                },
                e.prototype._reflowSmaller = function(e, t) {
                    for (var i = this.getNullCell(H.DEFAULT_ATTR_DATA), r = [], n = 0, s = this.lines.length - 1; 0 <= s; s--) {
                        var o = this.lines.get(s);
                        if (o.isWrapped || !(o.getTrimmedLength() <= e)) {
                            for (var a = [o]; o.isWrapped && 0 < s;) o = this.lines.get(--s),
                            a.unshift(o);
                            ...
                            if (! (s <= l && l < s + a.length)) {
                                ...
                                y = c[m];
                                0 === y && (y = c[--m]);
                                for (var g = a.length - u - 1,
                                C = h; 0 <= g;) {
                                    var v = Math.min(C, y);
                                    if (a[m].copyCellsFrom(a[g], C - v, y - v, v, !0), 0 === (y -= v) && (y = c[--m]), 0 === (C -= v)) {
                                        g--;
                                        var b = Math.max(g, 0);
                                        C = O.getWrappedLineTrimmedLength(a, b, this._cols)
                                    }
                                }
                                for (d = 0; d < a.length; d++) c[d] < e && a[d].setCell(c[d], i);
                                for (var w = u - f; 0 < w--;) 0 === this.ybase ? this.y < t - 1 ? (this.y++, this.lines.pop()) : (this.ybase++, this.ydisp++) : this.ybase < Math.min(this.lines.maxLength, this.lines.length + n) - t && (this.ybase === this.ydisp && this.ydisp++, this.ybase++)
                            }
                        }
                    }
                    if (0 < r.length) {
                        ...
                        var M = 0;
                        for (d = Math.min(this.lines.maxLength - 1, L + n - 1); 0 <= d; d--) if (T && T.start > A + M) {
                            for (var R = T.newLines.length - 1; 0 <= R; R--) this.lines.set(d--, T.newLines[R]);
                            d++,
                            S.push({
                                index: A + 1,
                        ...
                        var k = 0;
                        for (d = S.length - 1; 0 <= d; d--) S[d].index += k,
                ...
                e.prototype.stringIndexToBufferIndex = function(e, t, i) {
                    for (void 0 === i && (i = !1); t;) {
                        ...
                        if (!r) return [ - 1, -1];
                        for (var n = i ? r.getTrimmedLength() : r.length, s = 0; s < n; ++s) if (r.get(s)[H.CHAR_DATA_WIDTH_INDEX] && (t -= r.get(s)[H.CHAR_DATA_CHAR_INDEX].length || 1), t < 0) return [e, s];
                        e++
                    }
                    return [e, 0]
                },
                ...
                e.prototype.getWrappedRangeForLine = function(e) {
                    for (var t = e,
                    i = e; 0 < t && this.lines.get(t).isWrapped;) t--;
                ...
                e.prototype.setupTabStops = function(e) {
                    ...
                    e = 0); e < this._cols; e += this._terminal.options.tabStopWidth) this.tabs[e] = !0
                },
                ...
                e.prototype.addMarker = function(e) {
                    ...
                    i.register(this.lines.onTrim(function(e) {
                        i.line -= e,
                        i.line < 0 && i.dispose()
                    })),
                    i.register(this.lines.onInsert(function(e) {
                        i.line >= e.index && (i.line += e.amount)
                    })),
                    i.register(this.lines.onDelete(function(e) {
                        i.line >= e.index && i.line < e.index + e.amount && i.dispose(),
                        i.line > e.index && (i.line -= e.amount)
                    })),
                    i.register(i.onDispose(function() {
            ...
            var u = function() {
                ...
                e.prototype.next = function() {
                    ...
                    for (var t = "",
                    i = e.first; i <= e.last; ++i) t += this._buffer.translateBufferLineToString(i, this._trimRight);
            ...
            H.BufferStringIterator = u
        },
        {
            "../lib/common/Lifecycle": 26,
            "./BufferLine": 3,
            "./BufferReflow": 4,
            "./common/CircularList": 22,
            "./common/EventEmitter2": 25,
            "./renderer/atlas/Types": 52
        }],
        3 : [function(e, t, i) {
            "use strict";
            var r, n = this && this.__extends || (r = function(e, t) {
            ...
            var o = e("./Buffer"),
            a = e("./core/input/TextDecoder"),
            s = function() {
                function t() {
                    this.fg = 0,
                    this.bg = 0
                }
                return t.toColorRGB = function(e) {
                    return [e >>> 16 & 255, e >>> 8 & 255, 255 & e]
                },
                t.fromColorRGB = function(e) {
            ...
            l = function(t) {
                ...
                return n(i, t),
                i.fromCharData = function(e) {
                    var t = new i;
                    return t.setFromCharData(e),
                    t
                },
                i.prototype.isCombined = function() {
                    return 2097152 & this.content
                },
                i.prototype.getWidth = function() {
                    return this.content >> 22
                },
                i.prototype.getChars = function() {
                    return 2097152 & this.content ? this.combinedData: 2097151 & this.content ? a.stringFromCodePoint(2097151 & this.content) : ""
                },
                i.prototype.getCode = function() {
                    return this.isCombined() ? this.combinedData.charCodeAt(this.combinedData.length - 1) : 2097151 & this.content
                },
                i.prototype.setFromCharData = function(e) {
                    this.fg = e[o.CHAR_DATA_ATTR_INDEX],
                    this.bg = 0;
                    var t = !1;
                    if (2 < e[o.CHAR_DATA_CHAR_INDEX].length) t = !0;
                        ...
                        if (55296 <= i && i <= 56319) {
                            ...
                            56320 <= r && r <= 57343 ? this.content = 1024 * (i - 55296) + r - 56320 + 65536 | e[o.CHAR_DATA_WIDTH_INDEX] << 22 : t = !0
                        } else t = !0
                    } else this.content = e[o.CHAR_DATA_CHAR_INDEX].charCodeAt(0) | e[o.CHAR_DATA_WIDTH_INDEX] << 22;
                    t && (this.combinedData = e[o.CHAR_DATA_CHAR_INDEX], this.content = 2097152 | e[o.CHAR_DATA_WIDTH_INDEX] << 22)
                },
                i.prototype.getAsCharData = function() {
            ...
            var h = function() {
                function i(e, t, i) {
                    if (void 0 === i && (i = !1), this.isWrapped = i, this._data = null, this._combined = {},
                    e) {
                        this._data = new Uint32Array(3 * e);
                        for (var r = t || l.fromCharData([0, o.NULL_CELL_CHAR, o.NULL_CELL_WIDTH, o.NULL_CELL_CODE]), n = 0; n < e; ++n) this.setCell(n, r)
                    }
                    this.length = e
                }
                return i.prototype.get = function(e) {
                    ...
                    i = 2097151 & t;
                    return [this._data[3 * e + 1], 2097152 & t ? this._combined[e] : i ? a.stringFromCodePoint(i) : "", t >> 22, 2097152 & t ? this._combined[e].charCodeAt(this._combined[e].length - 1) : i]
                },
                i.prototype.set = function(e, t) {
                    this._data[3 * e + 1] = t[o.CHAR_DATA_ATTR_INDEX],
                    1 < t[o.CHAR_DATA_CHAR_INDEX].length ? (this._combined[e] = t[1], this._data[3 * e + 0] = 2097152 | e | t[o.CHAR_DATA_WIDTH_INDEX] << 22) : this._data[3 * e + 0] = t[o.CHAR_DATA_CHAR_INDEX].charCodeAt(0) | t[o.CHAR_DATA_WIDTH_INDEX] << 22
                },
                i.prototype.getWidth = function(e) {
                    return this._data[3 * e + 0] >> 22
                },
                i.prototype.hasWidth = function(e) {
                    return 12582912 & this._data[3 * e + 0]
                },
                i.prototype.getFg = function(e) {
                    return this._data[3 * e + 1]
                },
                i.prototype.getBg = function(e) {
                    return this._data[3 * e + 2]
                },
                i.prototype.hasContent = function(e) {
                    return 4194303 & this._data[3 * e + 0]
                },
                i.prototype.getCodePoint = function(e) {
                    var t = this._data[3 * e + 0];
                    return 2097152 & t ? this._combined[e].charCodeAt(this._combined[e].length - 1) : 2097151 & t
                },
                i.prototype.isCombined = function(e) {
                    return 2097152 & this._data[3 * e + 0]
                },
                i.prototype.getString = function(e) {
                    var t = this._data[3 * e + 0];
                    return 2097152 & t ? this._combined[e] : 2097151 & t ? a.stringFromCodePoint(2097151 & t) : ""
                },
                i.prototype.loadCell = function(e, t) {
                    var i = 3 * e;
                    return t.content = this._data[i + 0],
                    t.fg = this._data[i + 1],
                    t.bg = this._data[i + 2],
                    2097152 & t.content && (t.combinedData = this._combined[e]),
                    t
                },
                i.prototype.setCell = function(e, t) {
                    2097152 & t.content && (this._combined[e] = t.combinedData),
                    this._data[3 * e + 0] = t.content,
                    this._data[3 * e + 1] = t.fg,
                    this._data[3 * e + 2] = t.bg
                },
                i.prototype.setCellFromCodePoint = function(e, t, i, r, n) {
                    this._data[3 * e + 0] = t | i << 22,
                    this._data[3 * e + 1] = r,
                    this._data[3 * e + 2] = n
                },
                i.prototype.addCodepointToCell = function(e, t) {
                    var i = this._data[3 * e + 0];
                    2097152 & i ? this._combined[e] += a.stringFromCodePoint(t) : (2097151 & i ? (this._combined[e] = a.stringFromCodePoint(2097151 & i) + a.stringFromCodePoint(t), i &= -2097152, i |= 2097152) : i = t | 1 << 22, this._data[3 * e + 0] = i)
                },
                i.prototype.insertCells = function(e, t, i) {
                    if (e %= this.length, t < this.length - e) {
                        for (var r = new l,
                        n = this.length - e - t - 1; 0 <= n; --n) this.setCell(e + t + n, this.loadCell(e + n, r));
                ...
                i.prototype.deleteCells = function(e, t, i) {
                    if (e %= this.length, t < this.length - e) {
                        for (var r = new l,
                        n = 0; n < this.length - e - t; ++n) this.setCell(e + n, this.loadCell(e + t + n, r));
                        for (n = this.length - t; n < this.length; ++n) this.setCell(n, i)
                    } else for (n = e; n < this.length; ++n) this.setCell(n, i)
                },
                ...
                i.prototype.resize = function(e, t) {
                    if (e !== this.length) {
                        if (e > this.length) {
                            ...
                            this.length && (3 * e < this._data.length ? i.set(this._data.subarray(0, 3 * e)) : i.set(this._data)),
                            this._data = i;
                            for (var r = this.length; r < e; ++r) this.setCell(r, t)
                        } else if (e) { (i = new Uint32Array(3 * e)).set(this._data.subarray(0, 3 * e)),
                            this._data = i;
                ...
                i.prototype.clone = function() {
                    var e = new i(0);
                    for (var t in e._data = new Uint32Array(this._data), e.length = this.length, this._combined) e._combined[t] = this._combined[t];
                    return e.isWrapped = this.isWrapped,
                    e
                },
                i.prototype.getTrimmedLength = function() {
                    for (var e = this.length - 1; 0 <= e; --e) if (4194303 & this._data[3 * e + 0]) return e + (this._data[3 * e + 0] >> 22);
                    return 0
                },
                i.prototype.copyCellsFrom = function(e, t, i, r, n) {
                    var s = e._data;
                    if (n) for (var o = r - 1; 0 <= o; o--) for (var a = 0; a < 3; a++) this._data[3 * (i + o) + a] = s[3 * (t + o) + a];
                    else for (o = 0; o < r; o++) for (a = 0; a < 3; a++) this._data[3 * (i + o) + a] = s[3 * (t + o) + a];
                ...
                i.prototype.translateToString = function(e, t, i) {
                    ...
                    for (var r = ""; t < i;) {
                        ...
                        s = 2097151 & n;
                        r += 2097152 & n ? this._combined[t] : s ? a.stringFromCodePoint(s) : o.WHITESPACE_CELL_CHAR,
                        t += n >> 22 || 1
                    }
                    return r
                },
        ...
        4 : [function(e, t, i) {
            ...
            i.reflowLargerGetLinesToRemove = function(e, t, i, r, n) {
                for (var s = [], o = 0; o < e.length - 1; o++) {
                    ...
                    l = e.get(++a);
                    if (l.isWrapped) {
                        for (var h = [e.get(o)]; a < e.length && l.isWrapped;) h.push(l),
                        l = e.get(++a);
                        if (o <= r && r < a) o += h.length - 1;
                        else {
                            for (var c = 0,
                            u = v(h, c, t), f = 1, _ = 0; f < h.length;) {
                                var d = v(h, f, t),
                                p = d - _,
                                m = i - u,
                                y = Math.min(p, m);
                                ...
                                (u += y) === i && (c++, u = 0),
                                (_ += y) === d && (f++, _ = 0),
                                0 === u && 0 !== c && 2 === h[c - 1].getWidth(i - 1) && (h[c].copyCellsFrom(h[c - 1], i - 1, u++, 1, !1), h[c - 1].setCell(i - 1, n))
                            }
                            h[c].replaceCells(u, i, n);
                            for (var g = 0,
                            C = h.length - 1; 0 < C && (c < C || 0 === h[C].getTrimmedLength()); C--) g++;
            ...
            n = function() {
                ...
                e.prototype.measure = function(e) {
                    ...
                    if (0 !== t.width && 0 !== t.height) {
                        ...
                        this._width === t.width && this._height === i || (this._width = t.width, this._height = i, this._onCharSizeChanged.fire())
                    }
                },
                e
            } ();
        ...
        7 : [function(e, t, o) {
            ...
            o.wcwidth = function(e) {
                ...
                return function(e) {
                    return e < 32 ? 0 | r: e < 127 ? 1 : e < 65536 ? n[e] : function(e, t) {
                        var i, r = 0,
                        n = t.length - 1;
                        if (e < t[0][0] || e > t[n][1]) return ! 1;
                        for (; r <= n;) if (e > t[i = r + n >> 1][1]) r = i + 1;
                        else {
                            if (! (e < t[i][0])) return ! 0;
                            n = i - 1
                        }
                        return ! 1
                    } (t = e, i) ? 0 : 131072 <= t && t <= 196605 || 196608 <= t && t <= 262141 ? 2 : 1;
                    var t
                }
            } ({
                nul: 0,
            ...
            o.getStringCellWidth = function(e) {
                ...
                r = 0; r < i; ++r) {
                    ...
                    if (55296 <= n && n <= 56319) {
                        ...
                        56320 <= s && s <= 57343 ? n = 1024 * (n - 55296) + s - 56320 + 65536 : t += o.wcwidth(s)
                    }
                    t += o.wcwidth(n)
                }
                return t
        ...
        8 : [function(e, t, i) {
            ...
            i.copyHandler = function(e, t, i) {
                t.browser.isMSIE ? window.clipboardData.setData("Text", i.selectionText) : e.clipboardData.setData("text/plain", i.selectionText),
                e.preventDefault()
            },
            i.pasteHandler = function(t, i) {
                ...
                i.browser.isMSIE ? window.clipboardData && e(window.clipboardData.getData("Text")) : t.clipboardData && e(t.clipboardData.getData("text/plain"))
            },
                    ...
                    if (this._compositionView.classList.remove("active"), this._isComposing = !1, this._clearTextareaPosition(), e) {
                        ...
                        setTimeout(function() {
                            if (t._isSendingComposition) {
                                ...
                                var e = void 0;
                                e = t._isComposing ? t._textarea.value.substring(i.start, i.end) : t._textarea.value.substring(i.start),
        ...
        10 : [function(e, t, r) {
            ...
            var i = e("./common/Lifecycle"),
            S = e("./core/input/TextDecoder");
            function o(e, t) {
                for (var i = t - e,
                r = new Array(i); i--;) r[i] = --t;
                return r
            }
            var a = function() {
                function e(e) {
            ...
            h = o(0, 24);
            h.push(25),
            h.push.apply(h, o(28, 32));
            r.VT500_TRANSITION_TABLE = function() {
                var e, t = new a(4095),
                i = o(0, 14);
                for (e in i) for (var r = 0; r <= 160; ++r) t.add(r, e, 1, 0);
                for (e in t.addMany(l, 0, 2, 0), i) t.addMany([24, 26, 153, 154], e, 3, 0),
            ...
            u = function(i) {
                ...
                e.prototype.parse = function(e, t) {
                    ...
                    _ = null,
                    d = 0; d < t; ++d) if (i = e[d], 0 === s && 31 < i && i < 128) {
                        for (o = ~o ? o: d; ++d < t && 31 < e[d] && e[d] < 128;);
                        d--
                    } else if (4 === s && 47 < i && i < 57) c[c.length - 1] = 10 * c[c.length - 1] + i - 48;
                    else {
                        ...
                        case 3:
                            ...
                            (_ = this._executeHandlers[i]) ? _() : this._executeHandlerFb(i);
                            break;
                        case 0:
                            ~o ? (this._printHandler(e, o, d), o = -1) : ~a && (f.put(e, a, d), a = -1);
                            break;
                        case 1:
                            if (159 < i) switch (s) {
                            case 0:
                            ...
                            break;
                        case 7:
                            for (var p = this._csiHandlers[i], m = p ? p.length - 1 : -1; 0 <= m && !1 === p[m](c, h); m--);
                            m < 0 && this._csiHandlerFb(h, c, i);
                            break;
                        case 8:
                            59 === i ? c.push(0) : c[c.length - 1] = 10 * c[c.length - 1] + i - 48;
                            break;
                        case 9:
                            h += String.fromCharCode(i);
                            break;
                        case 10:
                            (_ = this._escHandlers[h + String.fromCharCode(i)]) ? _(h, i) : this._escHandlerFb(h, i);
                            break;
                        case 11:
                            ~o && (this._printHandler(e, o, d), o = -1),
                            c = [0],
                            ...
                            break;
                        case 12:
                            (f = this._dcsHandlers[h + String.fromCharCode(i)]) || (f = this._dcsHandlerFb),
                            f.hook(h, c, i);
                            break;
                        case 13:
                            a = ~a ? a: d;
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            for (var y = d + 1;; y++) if (t <= y || (i = e[y]) < 32 || 127 < i && i <= 159) {
                                l += S.utf32ToString(e, d, y),
                                d = y - 1;
                                break
                            }
                            break;
                        case 6:
                            if (l && 24 !== i && 26 !== i) {
                                ...
                                if ( - 1 === g) this._oscHandlerFb( - 1, l);
                                    ...
                                    for (var C = parseInt(l.substring(0, g)), v = l.substring(g + 1), b = this._oscHandlers[C], w = b ? b.length - 1 : -1; 0 <= w && !1 === b[w](v); w--);
                    ...
                    0 === s && ~o ? this._printHandler(e, o, t) : 13 === s && ~a && f && f.put(e, a, t),
                    this._osc = l,
                    this._collect = h,
                    this._params = c,
        ...
        11 : [function(e, t, i) {
            ...
            y = e("./core/input/TextDecoder"),
            c = e("./BufferLine"),
            u = e("./common/EventEmitter2"),
            f = {
                "(": 0,
                ")": 1,
                "*": 2,
            ...
            _ = function() {
                ...
                e.prototype.unhook = function() {
                    var e = y.utf32ToString(this._data);
                    ...
                    case "r":
                        ...
                        return this._terminal.handler(a.C0.ESC + "P1$r" + t + a.C0.ESC + "\\");
                    case "m":
                    ...
                    case " q":
                        ...
                        this._terminal.handler(a.C0.ESC + "P1$r" + i + " q" + a.C0.ESC + "\\");
                    default:
                        this._terminal.error("Unknown DCS $q %s", e),
                        this._terminal.handler(a.C0.ESC + "P0$r" + a.C0.ESC + "\\")
                    }
                },
                e
            } (),
            d = function(o) {
                function e(e, t) {
                    ...
                    r._stringDecoder = new y.StringToUtf32,
                    r._workCell = new c.CellData,
                    r._onCursorMove = new u.EventEmitter2,
                    r._onData = new u.EventEmitter2,
                    r._onLineFeed = new u.EventEmitter2,
                    r._onScroll = new u.EventEmitter2,
                    ...
                    r._parser.setCsiHandler("@",
                    function(e, t) {
                        return r.insertChars(e)
                    }),
                    r._parser.setCsiHandler("A",
                    function(e, t) {
                        return r.cursorUp(e)
                    }),
                    r._parser.setCsiHandler("B",
                    function(e, t) {
                        return r.cursorDown(e)
                    }),
                    r._parser.setCsiHandler("C",
                    function(e, t) {
                        return r.cursorForward(e)
                    }),
                    r._parser.setCsiHandler("D",
                    function(e, t) {
                        return r.cursorBackward(e)
                    }),
                    r._parser.setCsiHandler("E",
                    function(e, t) {
                        return r.cursorNextLine(e)
                    }),
                    r._parser.setCsiHandler("F",
                    function(e, t) {
                        return r.cursorPrecedingLine(e)
                    }),
                    r._parser.setCsiHandler("G",
                    function(e, t) {
                        return r.cursorCharAbsolute(e)
                    }),
                    r._parser.setCsiHandler("H",
                    function(e, t) {
                        return r.cursorPosition(e)
                    }),
                    r._parser.setCsiHandler("I",
                    function(e, t) {
                        return r.cursorForwardTab(e)
                    }),
                    r._parser.setCsiHandler("J",
                    function(e, t) {
                        return r.eraseInDisplay(e)
                    }),
                    r._parser.setCsiHandler("K",
                    function(e, t) {
                        return r.eraseInLine(e)
                    }),
                    r._parser.setCsiHandler("L",
                    function(e, t) {
                        return r.insertLines(e)
                    }),
                    r._parser.setCsiHandler("M",
                    function(e, t) {
                        return r.deleteLines(e)
                    }),
                    r._parser.setCsiHandler("P",
                    function(e, t) {
                        return r.deleteChars(e)
                    }),
                    r._parser.setCsiHandler("S",
                    function(e, t) {
                        return r.scrollUp(e)
                    }),
                    r._parser.setCsiHandler("T",
                    function(e, t) {
                        return r.scrollDown(e, t)
                    }),
                    r._parser.setCsiHandler("X",
                    function(e, t) {
                        return r.eraseChars(e)
                    }),
                    r._parser.setCsiHandler("Z",
                    function(e, t) {
                    ...
                    r._parser.setCsiHandler("q",
                    function(e, t) {
                        return r.setCursorStyle(e, t)
                    }),
                    r._parser.setCsiHandler("r",
                    function(e, t) {
                    ...
                    r._parser.setCsiHandler("u",
                    function(e, t) {
                        return r.restoreCursor(e)
                    }),
                    r._parser.setExecuteHandler(a.C0.BEL,
                    function() {
                        return r.bell()
                    }),
                    r._parser.setExecuteHandler(a.C0.LF,
                    function() {
                        return r.lineFeed()
                    }),
                    r._parser.setExecuteHandler(a.C0.VT,
                    function() {
                        return r.lineFeed()
                    }),
                    r._parser.setExecuteHandler(a.C0.FF,
                    function() {
                        return r.lineFeed()
                    }),
                    r._parser.setExecuteHandler(a.C0.CR,
                    function() {
                        return r.carriageReturn()
                    }),
                    r._parser.setExecuteHandler(a.C0.BS,
                    function() {
                        return r.backspace()
                    }),
                    r._parser.setExecuteHandler(a.C0.HT,
                    function() {
                        return r.tab()
                    }),
                    r._parser.setExecuteHandler(a.C0.SO,
                    function() {
                        return r.shiftOut()
                    }),
                    r._parser.setExecuteHandler(a.C0.SI,
                    function() {
                        return r.shiftIn()
                    }),
                    r._parser.setExecuteHandler(a.C1.IND,
                    function() {
                        return r.index()
                    }),
                    r._parser.setExecuteHandler(a.C1.NEL,
                    function() {
                        return r.nextLine()
                    }),
                    r._parser.setExecuteHandler(a.C1.HTS,
                    function() {
                        return r.tabSet()
                    }),
                    r._parser.setOscHandler(0,
                    function(e) {
                        return r.setTitle(e)
                    }),
                    r._parser.setOscHandler(2,
                    function(e) {
                        return r.setTitle(e)
                    }),
                    r._parser.setEscHandler("7",
                    function() {
                        return r.saveCursor([])
                    }),
                    r._parser.setEscHandler("8",
                    function() {
                        return r.restoreCursor([])
                    }),
                    r._parser.setEscHandler("D",
                    function() {
                        return r.index()
                    }),
                    r._parser.setEscHandler("E",
                    function() {
                        return r.nextLine()
                    }),
                    r._parser.setEscHandler("H",
                    function() {
                        return r.tabSet()
                    }),
                    r._parser.setEscHandler("M",
                    function() {
                        return r.reverseIndex()
                    }),
                    r._parser.setEscHandler("=",
                    function() {
                    ...
                    r._parser.setEscHandler("c",
                    function() {
                        return r.reset()
                    }),
                    r._parser.setEscHandler("n",
                    function() {
                        return r.setgLevel(2)
                    }),
                    r._parser.setEscHandler("o",
                    function() {
                    ...
                    r._parser.setEscHandler("%G",
                    function() {
                        return r.selectDefaultCharset()
                    });
                    var i = function(e) {
                        n._parser.setEscHandler("(" + e,
                        function() {
                    ...
                    return r._parser.setErrorHandler(function(e) {
                        return r._terminal.error("Parsing error: ", e),
                        e
                    }),
                    r._parser.setDcsHandler("$q", new _(r._terminal)),
                    r
                }
                return n(e, o),
                ...
                e.prototype.parse = function(e) {
                    if (this._terminal) {
                        ...
                        this._parseBuffer.length < e.length && (this._parseBuffer = new Uint32Array(e.length)),
                        this._parser.parse(this._parseBuffer, this._stringDecoder.decode(e, this._parseBuffer)),
                        (t = this._terminal.buffer).x === i && t.y === r || this._onCursorMove.fire()
                    }
                },
                e.prototype.print = function(e, t, i) {
                    var r, n, s = this._terminal.buffer,
                    ...
                    for (var _ = t; _ < i; ++_) {
                        if (r = e[_], n = m.wcwidth(r), r < 127 && o) {
                            var d = o[String.fromCharCode(r)];
                            d && (r = d.charCodeAt(0))
                        }
                        if (a && this._terminal.emit("a11y.char", y.stringFromCodePoint(r)), n || !s.x) {
                            if (s.x + n - 1 >= l) if (h) s.x = 0,
                            s.y++,
                            s.y > s.scrollBottom ? (s.y--, this._terminal.scroll(!0)) : s.lines.get(s.y).isWrapped = !0,
                            f = s.lines.get(s.y + s.ybase);
                            else if (2 === n) continue;
                            if (c && (f.insertCells(s.x, n, s.getNullCell(u)), 2 === f.getWidth(l - 1) && f.setCellFromCodePoint(l - 1, p.NULL_CELL_CODE, p.NULL_CELL_WIDTH, u.fg, u.bg)), f.setCellFromCodePoint(s.x++, r, n, u.fg, u.bg), 0 < n) for (; --n;) f.setCellFromCodePoint(s.x++, 0, 0, u.fg, u.bg)
                        } else f.getWidth(s.x - 1) ? f.addCodepointToCell(s.x - 1, r) : f.addCodepointToCell(s.x - 2, r)
                    }
                    this._terminal.updateRange(s.y)
                },
                e.prototype.addCsiHandler = function(e, t) {
                ...
                e.prototype.tab = function() {
                    ...
                    this._terminal.options.screenReaderMode && this._terminal.emit("a11y.tab", this._terminal.buffer.x - e)
                },
                ...
                e.prototype.insertChars = function(e) {
                    this._terminal.buffer.lines.get(this._terminal.buffer.y + this._terminal.buffer.ybase).insertCells(this._terminal.buffer.x, e[0] || 1, this._terminal.buffer.getNullCell(this._terminal.eraseAttrData())),
                ...
                e.prototype.cursorPosition = function(e) {
                    ...
                    i < 0 ? i = 0 : i >= this._terminal.rows && (i = this._terminal.rows - 1),
                    t < 0 ? t = 0 : t >= this._terminal.cols && (t = this._terminal.cols - 1),
                    this._terminal.buffer.x = t,
                ...
                e.prototype._eraseInBufferLine = function(e, t, i, r) {
                    ...
                    n.replaceCells(t, i, this._terminal.buffer.getNullCell(this._terminal.eraseAttrData())),
                    r && (n.isWrapped = !1)
                },
                ...
                e.prototype.eraseInDisplay = function(e) {
                    ...
                    case 3:
                        ...
                        0 < i && (this._terminal.buffer.lines.trimStart(i), this._terminal.buffer.ybase = Math.max(this._terminal.buffer.ybase - i, 0), this._terminal.buffer.ydisp = Math.max(this._terminal.buffer.ydisp - i, 0), this._onScroll.fire(0))
                    }
                },
                ...
                e.prototype.insertLines = function(e) {
                    ...
                    s = this._terminal.rows - 1 + i.ybase - n + 1; t--;) i.lines.splice(s - 1, 1),
                    i.lines.splice(r, 0, i.getBlankLine(this._terminal.eraseAttrData()));
                ...
                e.prototype.deleteLines = function(e) {
                    var t = e[0];
                    t < 1 && (t = 1);
                    var i, r = this._terminal.buffer,
                    n = r.y + r.ybase;
                    for (i = this._terminal.rows - 1 - r.scrollBottom, i = this._terminal.rows - 1 + r.ybase - i; t--;) r.lines.splice(n, 1),
                    r.lines.splice(i, 0, r.getBlankLine(this._terminal.eraseAttrData()));
                    this._terminal.updateRange(r.y),
                    this._terminal.updateRange(r.scrollBottom)
                },
                e.prototype.deleteChars = function(e) {
                    this._terminal.buffer.lines.get(this._terminal.buffer.y + this._terminal.buffer.ybase).deleteCells(this._terminal.buffer.x, e[0] || 1, this._terminal.buffer.getNullCell(this._terminal.eraseAttrData())),
                    this._terminal.updateRange(this._terminal.buffer.y)
                },
                e.prototype.scrollUp = function(e) {
                    for (var t = e[0] || 1, i = this._terminal.buffer; t--;) i.lines.splice(i.ybase + i.scrollTop, 1),
                    i.lines.splice(i.ybase + i.scrollBottom, 0, i.getBlankLine(p.DEFAULT_ATTR_DATA));
                    this._terminal.updateRange(i.scrollTop),
                    this._terminal.updateRange(i.scrollBottom)
                },
                e.prototype.scrollDown = function(e, t) {
                    if (e.length < 2 && !t) {
                        for (var i = e[0] || 1, r = this._terminal.buffer; i--;) r.lines.splice(r.ybase + r.scrollBottom, 1),
                        r.lines.splice(r.ybase + r.scrollTop, 0, r.getBlankLine(p.DEFAULT_ATTR_DATA));
                ...
                e.prototype.repeatPrecedingCharacter = function(e) {
                    ...
                    i.replaceCells(t.x, t.x + (e[0] || 1), void 0 !== this._workCell.content ? this._workCell: t.getNullCell(p.DEFAULT_ATTR_DATA))
                },
                e.prototype.sendDeviceAttributes = function(e, t) {
                    0 < e[0] || (t ? ">" === t && (this._terminal.is("xterm") ? this._terminal.handler(a.C0.ESC + "[>0;276;0c") : this._terminal.is("rxvt-unicode") ? this._terminal.handler(a.C0.ESC + "[>85;95;0c") : this._terminal.is("linux") ? this._terminal.handler(e[0] + "c") : this._terminal.is("screen") && this._terminal.handler(a.C0.ESC + "[>83;40003;0c")) : this._terminal.is("xterm") || this._terminal.is("rxvt-unicode") || this._terminal.is("screen") ? this._terminal.handler(a.C0.ESC + "[?1;2c") : this._terminal.is("linux") && this._terminal.handler(a.C0.ESC + "[?6c"))
                },
                ...
                e.prototype.setMode = function(e, t) {
                    if (1 < e.length) for (var i = 0; i < e.length; i++) this.setMode([e[i]]);
                    else if (t) {
                        if ("?" === t) switch (e[0]) {
                        case 1:
                        ...
                        case 1003:
                            ...
                            this._terminal.element && this._terminal.element.classList.add("enable-mouse-events"),
                            this._terminal.selectionManager && this._terminal.selectionManager.disable(),
                ...
                e.prototype.resetMode = function(e, t) {
                    if (1 < e.length) for (var i = 0; i < e.length; i++) this.resetMode([e[i]]);
                    else if (t) {
                        if ("?" === t) switch (e[0]) {
                        case 1:
                        ...
                        case 1003:
                            ...
                            this._terminal.element && this._terminal.element.classList.remove("enable-mouse-events"),
                ...
                e.prototype.charAttributes = function(e) {
                    if (1 === e.length && 0 === e[0]) return this._terminal.curAttrData.fg = p.DEFAULT_ATTR_DATA.fg,
                    void(this._terminal.curAttrData.bg = p.DEFAULT_ATTR_DATA.bg);
                    for (var t, i = e.length,
                    r = this._terminal.curAttrData,
                    n = 0; n < i; n++) 30 <= (t = e[n]) && t <= 37 ? (r.fg &= -50331904, r.fg |= 16777216 | t - 30) : 40 <= t && t <= 47 ? (r.bg &= -50331904, r.bg |= 16777216 | t - 40) : 90 <= t && t <= 97 ? (r.fg &= -50331904, r.fg |= 16777224 | t - 90) : 100 <= t && t <= 107 ? (r.bg &= -50331904, r.bg |= 16777224 | t - 100) : 0 === t ? (r.fg = p.DEFAULT_ATTR_DATA.fg, r.bg = p.DEFAULT_ATTR_DATA.bg) : 1 === t ? r.fg |= 134217728 : 3 === t ? r.bg |= 67108864 : 4 === t ? r.fg |= 268435456 : 5 === t ? r.fg |= 536870912 : 7 === t ? r.fg |= 67108864 : 8 === t ? r.fg |= 1073741824 : 2 === t ? r.bg |= 134217728 : 22 === t ? (r.fg &= -134217729, r.bg &= -134217729) : 23 === t ? r.bg &= -67108865 : 24 === t ? r.fg &= -268435457 : 25 === t ? r.fg &= -536870913 : 27 === t ? r.fg &= -67108865 : 28 === t ? r.fg &= -1073741825 : 39 === t ? (r.fg &= -67108864, r.fg |= 16777215 & p.DEFAULT_ATTR_DATA.fg) : 49 === t ? (r.bg &= -67108864, r.bg |= 16777215 & p.DEFAULT_ATTR_DATA.bg) : 38 === t ? 2 === e[n + 1] ? (n += 2, r.fg |= 50331648, r.fg &= -16777216, r.fg |= c.AttributeData.fromColorRGB([e[n], e[n + 1], e[n + 2]]), n += 2) : 5 === e[n + 1] && (t = 255 & e[n += 2], r.fg &= -256, r.fg |= 33554432 | t) : 48 === t ? 2 === e[n + 1] ? (n += 2, r.bg |= 50331648, r.bg &= -16777216, r.bg |= c.AttributeData.fromColorRGB([e[n], e[n + 1], e[n + 2]]), n += 2) : 5 === e[n + 1] && (t = 255 & e[n += 2], r.bg &= -256, r.bg |= 33554432 | t) : 100 === t ? (r.fg &= -67108864, r.fg |= 16777215 & p.DEFAULT_ATTR_DATA.fg, r.bg &= -67108864, r.bg |= 16777215 & p.DEFAULT_ATTR_DATA.bg) : this._terminal.error("Unknown SGR attribute: %d.", t)
                },
                e.prototype.deviceStatus = function(e, t) {
                    if (t) {
                        ...
                        case 6:
                            ...
                            this._onData.fire(a.C0.ESC + "[?" + i + ";" + r + "R")
                        }
                    } else switch (e[0]) {
                    case 5:
                        this._onData.fire(a.C0.ESC + "[0n");
                        break;
                    case 6:
                ...
                e.prototype.selectCharset = function(e) {
                    2 === e.length ? "/" !== e[0] && this._terminal.setgCharset(f[e[0]], l.CHARSETS[e[1]] || l.DEFAULT_CHARSET) : this.selectDefaultCharset()
                },
        ...
        },
        {
            ...
            "./BufferLine": 3,
            "./CharWidth": 7,
            "./EscapeSequenceParser": 10,
            "./common/EventEmitter2": 25,
            "./common/Lifecycle": 26,
            "./common/TypedArrayUtils": 28,
            "./common/data/EscapeSequences": 29,
            "./core/data/Charsets": 30,
            "./core/input/TextDecoder": 32
        }],
        12 : [function(e, t, i) {
            "use strict";
            ...
            n = function() {
                ...
                return Object.defineProperty(a.prototype, "onLinkHover", {
                    get: function() {
                ...
                a.prototype._linkifyRows = function() {
                    ...
                    if (! (t >= e.lines.length)) {
                        for (var i = e.ydisp + Math.min(this._rowsToLinkify.end, this._terminal.rows) + 1, r = Math.ceil(a.OVERSCAN_CHAR_LIMIT / this._terminal.cols), n = this._terminal.buffer.iterator(!1, t, i, r, r); n.hasNext();) for (var s = n.next(), o = 0; o < this._linkMatchers.length; o++) this._doLinkifyRow(s.range.first, s.content, this._linkMatchers[o]);
                ...
                a.prototype.registerLinkMatcher = function(e, t, i) {
                    ...
                    return this._addLinkMatcherToList(r),
                    r.id
                },
                a.prototype._addLinkMatcherToList = function(e) {
                    if (0 !== this._linkMatchers.length) {
                        for (var t = this._linkMatchers.length - 1; 0 <= t; t--) if (e.priority <= this._linkMatchers[t].priority) return void this._linkMatchers.splice(t + 1, 0, e);
                        this._linkMatchers.splice(0, 0, e)
                    } else this._linkMatchers.push(e)
                },
                a.prototype.deregisterLinkMatcher = function(e) {
                    for (var t = 0; t < this._linkMatchers.length; t++) if (this._linkMatchers[t].id === e) return this._linkMatchers.splice(t, 1),
                    !0;
                    return ! 1
                },
                a.prototype._doLinkifyRow = function(n, s, o) {
                    for (var a, l = this,
                    h = new RegExp(o.regex.source, o.regex.flags + "g"), c = -1, e = function() {
                        var t = a["number" != typeof o.matchIndex ? 0 : o.matchIndex];
                        if (!t) {
                            if (u._terminal.debug) throw console.log({
                                match: a,
                                matcher: o
                            }),
                        ...
                        if (c = s.indexOf(t, c + 1), h.lastIndex = c + t.length, c < 0) return "break";
                        var i = u._terminal.buffer.stringIndexToBufferIndex(n, c);
                        if (i[0] < 0) return "break";
                        var r, e = u._terminal.buffer.lines.get(i[0]).getFg(i[1]);
                        e && (r = e >> 9 & 511),
                        o.validationCallback ? o.validationCallback(t,
                        function(e) {
                            l._rowsTimeoutId || e && l._addLink(i[1], i[0] - l._terminal.buffer.ydisp, t, o, r)
                        }) : u._addLink(i[1], i[0] - u._terminal.buffer.ydisp, t, o, r)
                    },
                    u = this; null !== (a = h.exec(s));) {
                        if ("break" === e()) break
                    }
                },
                a.prototype._addLink = function(e, t, i, r, n) {
                    ...
                    this._mouseZoneManager.add(new u.MouseZone(a + 1, l + 1, h + 1, c + 1,
                    function(e) {
                        if (r.handler) return r.handler(e, i);
                        window.open(i, "_blank")
                    },
                    function() {
                        s._onLinkHover.fire(s._createLinkHoverEvent(a, l, h, c, n)),
                        s._terminal.element.classList.add("xterm-cursor-pointer")
                    },
                    function(e) {
                        s._onLinkTooltip.fire(s._createLinkHoverEvent(a, l, h, c, n)),
                        r.hoverTooltipCallback && r.hoverTooltipCallback(e, i)
                    },
                    function() {
                        s._onLinkLeave.fire(s._createLinkHoverEvent(a, l, h, c, n)),
        ...
        13 : [function(e, t, i) {
            ...
            var r = function() {
                ...
                a.prototype.getCoords = function(e, t, i, r, n, s) {
                    ...
                    return o ? (o[0] = Math.ceil((o[0] + (s ? this._renderer.dimensions.actualCellWidth / 2 : 0)) / this._renderer.dimensions.actualCellWidth), o[1] = Math.ceil(o[1] / this._renderer.dimensions.actualCellHeight), o[0] = Math.min(Math.max(o[0], 1), r + (s ? 1 : 0)), o[1] = Math.min(Math.max(o[1], 1), n), o) : null
                },
        ...
        14 : [function(e, t, i) {
            ...
            a = function(i) {
                function e(e) {
                    var t = i.call(this) || this;
                    return t._terminal = e,
                    t._zones = [],
                    t._areZonesActive = !1,
                    t._tooltipTimeout = null,
                    t._currentZone = null,
                    t._lastHoverCoords = [null, null],
                    t.register(o.addDisposableDomListener(t._terminal.element, "mousedown",
                    function(e) {
                ...
                e.prototype.clearAll = function(e, t) {
                    if (0 !== this._zones.length) {
                        ...
                        for (var i = 0; i < this._zones.length; i++) {
                            var r = this._zones[i]; (r.y1 > e && r.y1 <= t + 1 || r.y2 > e && r.y2 <= t + 1 || r.y1 < e && r.y2 > t + 1) && (this._currentZone && this._currentZone === r && (this._currentZone.leaveCallback(), this._currentZone = null), this._zones.splice(i--, 1))
                        }
                ...
                e.prototype._onHover = function(e) {
                    ...
                    i !== this._currentZone && (this._currentZone && (this._currentZone.leaveCallback(), this._currentZone = null, this._tooltipTimeout && clearTimeout(this._tooltipTimeout)), i && ((this._currentZone = i).hoverCallback && i.hoverCallback(e), this._tooltipTimeout = setTimeout(function() {
                ...
                e.prototype._onClick = function(e) {
                    ...
                    t && i === this._initialSelectionLength && (t.clickCallback(e), e.preventDefault(), e.stopImmediatePropagation())
                },
        ...
        15 : [function(e, t, i) {
            ...
            u = function() {
                ...
                e.prototype.initBuffersListeners = function() {
                    var t = this;
                    this._trimListener = this._terminal.buffer.lines.onTrim(function(e) {
                        return t._onTrim(e)
                    }),
                    ...
                    get: function() {
                        ...
                        if (3 === this._activeSelectionMode) {
                            ...
                            if (e[1] !== t[1]) {
                                ...
                                n = this._buffer.translateBufferLineToString(t[1], !0, 0, t[0]);
                                o.isWrapped ? i[i.length - 1] += n: i.push(n)
                            }
                        }
                ...
                e.prototype.refresh = function(e) {
                    var t = this; (this._refreshAnimationFrame || (this._refreshAnimationFrame = window.requestAnimationFrame(function() {
                        return t._refresh()
                ...
                e.prototype._areCoordsInSelection = function(e, t, i) {
                ...
                e.prototype._getMouseEventScrollAmount = function(e) {
                    var t = r.MouseHelper.getCoordsRelativeToElement(e, this._terminal.screenElement)[1],
                    i = this._terminal.rows * Math.ceil(this._charMeasure.height * this._terminal.options.lineHeight);
                    return 0 <= t && t <= i ? 0 : (i < t && (t -= i), t = Math.min(Math.max(t, -50), 50), (t /= 50) / Math.abs(t) + Math.round(14 * t))
                },
                e.prototype.shouldForceSelection = function(e) {
                    return a.isMac ? e.altKey && this._terminal.options.macOptionClickForcesSelection: e.shiftKey
                },
                ...
                e.prototype._removeMouseDownListeners = function() {
                    this._terminal.element.ownerDocument && (this._terminal.element.ownerDocument.removeEventListener("mousemove", this._mouseMoveListener), this._terminal.element.ownerDocument.removeEventListener("mouseup", this._mouseUpListener)),
                ...
                e.prototype.shouldColumnSelect = function(e) {
                    return e.altKey && !(a.isMac && this._terminal.options.macOptionClickForcesSelection)
                },
                e.prototype._onMouseMove = function(e) {
                    e.stopImmediatePropagation();
                ...
                e.prototype._onMouseUp = function(e) {
                    ...
                    this._removeMouseDownListeners(),
                    this.selectionText.length <= 1 && t < 500 ? new s.AltClickHandler(e, this._terminal).move() : this.hasSelection && this._onSelectionChange.fire()
                },
                ...
                e.prototype._convertViewportColToCharacterIndex = function(e, t) {
                    for (var i = t[0], r = 0; t[0] >= r; r++) {
                        ...
                        0 === this._workCell.getWidth() ? i--:1 < n && t[0] !== r && (i += n - 1)
                    }
                    return i
                },
                ...
                e.prototype._getWordAt = function(e, t, i, r) {
                    ...
                    if (" " === s.charAt(o)) {
                        ...
                        for (1 < p && (f += p - 1, a += p - 1); 0 < _ && 0 < o && !this._isCharWordSeparator(n.loadCell(_ - 1, this._workCell));) {
                            n.loadCell(_ - 1, this._workCell);
                            var m = this._workCell.getChars().length;
                            0 === this._workCell.getWidth() ? (h++, _--) : 1 < m && (u += m - 1, o -= m - 1),
                            o--,
                            _--
                        }
                        for (; d < n.length && a + 1 < s.length && !this._isCharWordSeparator(n.loadCell(d + 1, this._workCell));) {
                            n.loadCell(d + 1, this._workCell);
                            var y = this._workCell.getChars().length;
                            2 === this._workCell.getWidth() ? (c++, d++) : 1 < y && (f += y - 1, a += y - 1),
                            a++,
                            d++
                        }
                    }
                    ...
                    if (i && 0 === g && 32 !== n.getCodePoint(0)) {
                        ...
                        if (v && n.isWrapped && 32 !== v.getCodePoint(this._terminal.cols - 1)) {
                            var b = this._getWordAt([this._terminal.cols - 1, e[1] - 1], !1, !0, !1);
                            if (b) {
                    ...
                    if (r && g + C === this._terminal.cols && 32 !== n.getCodePoint(this._terminal.cols - 1)) {
                ...
                e.prototype._selectWordAt = function(e, t) {
                    ...
                    if (i) {
                        for (; i.start < 0;) i.start += this._terminal.cols,
                        e[1]--;
                ...
                e.prototype._selectToWordAt = function(e) {
                    ...
                    if (t) {
                        for (var i = e[1]; t.start < 0;) t.start += this._terminal.cols,
                        i--;
                        if (!this._model.areSelectionValuesReversed()) for (; t.start + t.length > this._terminal.cols;) t.length -= this._terminal.cols,
                        i++;
                ...
                e.prototype._isCharWordSeparator = function(e) {
                    return 0 !== e.getWidth() && 0 <= " ()[]{}'\"".indexOf(e.getChars())
                },
            ...
            var r = function() {
                ...
                Object.defineProperty(e.prototype, "finalSelectionEnd", {
                    get: function() {
                        ...
                        if (this.selectionEnd && !this.areSelectionValuesReversed()) return this.selectionStartLength && this.selectionEnd[1] === this.selectionStart[1] ? [Math.max(this.selectionStart[0] + this.selectionStartLength, this.selectionEnd[0]), this.selectionEnd[1]] : this.selectionEnd;
                ...
                e.prototype.onTrim = function(e) {
                    ...
                    this.selectionEnd && this.selectionEnd[1] < 0 ? (this.clearSelection(), !0) : (this.selectionStart && this.selectionStart[1] < 0 && (this.selectionStart[1] = 0), !1)
                },
                e
            } ();
            i.SelectionModel = r
            ...
            var r = function() {
                ...
                return Object.defineProperty(r, "audioContext", {
                    get: function() {
                        if (!r._audioContext) {
                            ...
                            if (!e) return console.warn("Web Audio API is not supported by this browser. Consider upgrading to the latest version"),
                            null;
                ...
                r.prototype.playBellSound = function() {
                    ...
                    if (t) {
                        ...
                        t.decodeAudioData(this._base64ToArrayBuffer(this._removeMimeType(this._terminal.options.bellSound)),
                        function(e) {
                            i.buffer = e,
        ...
        19 : [function(e, t, i) {
            ...
            v = e("./MouseHelper"),
            b = e("./SoundManager"),
            w = e("./MouseZoneManager"),
            S = e("./AccessibilityManager"),
            E = e("./ui/ScreenDprMonitor"),
            ...
            O = function(i) {
                ...
                e.prototype.dispose = function() {
                    i.prototype.dispose.call(this),
                    this._windowsMode && (this._windowsMode.dispose(), this._windowsMode = void 0),
                ...
                e.prototype._setup = function() {
                    ...
                    Object.keys(H).forEach(function(e) {
                        null !== t.options[e] && void 0 !== t.options[e] || (t.options[e] = H[e])
                    }),
                    ...
                    this.glevel = 0,
                    this.charsets = [null],
                    this.curAttrData = o.DEFAULT_ATTR_DATA.clone(),
                    ...
                    this.options.windowsMode && (this._windowsMode = R.applyWindowsMode(this))
                },
                ...
                e.prototype.eraseAttrData = function() {
                    return this._eraseAttrData.bg &= -67108864,
                ...
                Object.defineProperty(e.prototype, "isFocused", {
                    get: function() {
                        return k.activeElement === this.textarea && k.hasFocus()
                    },
                    enumerable: !0,
                    configurable: !0
                }),
                ...
                e.prototype.setOption = function(e, t) {
                    if (! (e in H)) throw new Error('No option with key "' + e + '"');
                    if ( - 1 !== D.indexOf(e) && console.error('Option "' + e + '" can only be set in the constructor'), this.options[e] !== t) {
                        switch (e) {
                        case "bellStyle":
                            t || (t = "none");
                            break;
                        ...
                        case "scrollback":
                            ...
                            if (this.options[e] !== t) {
                                ...
                                if (this.buffer.lines.length > i) {
                                    ...
                                    this.buffer.ybase = Math.max(this.buffer.ybase - r, 0),
                                    this.buffer.ydisp = Math.max(this.buffer.ydisp - r, 0),
                        ...
                        case "fontWeightBold":
                            ...
                            break;
                        case "rendererType":
                            this.renderer && (this.unregister(this.renderer), this.renderer.dispose(), this.renderer = null),
                            this._setupRenderer(),
                        ...
                        case "screenReaderMode":
                            t ? this._accessibilityManager || (this._accessibilityManager = new S.AccessibilityManager(this)) : this._accessibilityManager && (this._accessibilityManager.dispose(), this._accessibilityManager = null);
                            break;
                        case "tabStopWidth":
                ...
                e.prototype._onTextAreaFocus = function(e) {
                ...
                e.prototype._initGlobal = function() {
                    var t = this;
                    this._bindKeys(),
                    this.register(g.addDisposableDomListener(this.element, "copy",
                    function(e) {
                        t.hasSelection() && c.copyHandler(e, t, t.selectionManager)
                    }));
                    var e = function(e) {
                    ...
                    y.isFirefox ? this.register(g.addDisposableDomListener(this.element, "mousedown",
                    function(e) {
                        2 === e.button && c.rightClickHandler(e, t, t.selectionManager, t.options.rightClickSelectsWord)
                    })) : this.register(g.addDisposableDomListener(this.element, "contextmenu",
                    function(e) {
                        c.rightClickHandler(e, t, t.selectionManager, t.options.rightClickSelectsWord)
                    })),
                    y.isLinux && this.register(g.addDisposableDomListener(this.element, "auxclick",
                    function(e) {
                ...
                e.prototype._bindKeys = function() {
                    var i = this,
                    r = this;
                    this.register(g.addDisposableDomListener(this.element, "keydown",
                    function(e) {
                        k.activeElement === this && r._keyDown(e)
                    },
                    !0)),
                    this.register(g.addDisposableDomListener(this.element, "keypress",
                    function(e) {
                        k.activeElement === this && r._keyPress(e)
                    },
                    !0)),
                    this.register(g.addDisposableDomListener(this.element, "keyup",
                    function(e) {
                        var t;
                        16 !== (t = e).keyCode && 17 !== t.keyCode && 18 !== t.keyCode && i.focus(),
                        r._keyUp(e)
                    },
                    !0)),
                    this.register(g.addDisposableDomListener(this.textarea, "keydown",
                    function(e) {
                        return i._keyDown(e)
                    },
                    !0)),
                    this.register(g.addDisposableDomListener(this.textarea, "keypress",
                    function(e) {
                        return i._keyPress(e)
                    },
                    !0)),
                    this.register(g.addDisposableDomListener(this.textarea, "compositionstart",
                    function() {
                        return i._compositionHelper.compositionstart()
                    })),
                    this.register(g.addDisposableDomListener(this.textarea, "compositionupdate",
                    function(e) {
                        return i._compositionHelper.compositionupdate(e)
                    })),
                    this.register(g.addDisposableDomListener(this.textarea, "compositionend",
                    function() {
                        return i._compositionHelper.compositionend()
                    })),
                    this.register(this.onRender(function() {
                        return i._compositionHelper.updateCompositionElements()
                    })),
                ...
                e.prototype.open = function(e) {
                    ...
                    this._screenDprMonitor = new E.ScreenDprMonitor,
                    ...
                    this._mouseZoneManager = new w.MouseZoneManager(this),
                    ...
                    this.textarea.setAttribute("aria-label", C.promptLabel),
                    this.textarea.setAttribute("aria-multiline", "false"),
                    this.textarea.setAttribute("autocorrect", "off"),
                    this.textarea.setAttribute("autocapitalize", "off"),
                    this.textarea.setAttribute("spellcheck", "false"),
                    this.textarea.tabIndex = 0,
                    this.register(g.addDisposableDomListener(this.textarea, "focus",
                    function(e) {
                        return t._onTextAreaFocus(e)
                    })),
                    this.register(g.addDisposableDomListener(this.textarea, "blur",
                    function() {
                    ...
                    this.charMeasure = new m.CharMeasure(k, this._helperContainer),
                    this.element.appendChild(i),
                    this._setupRenderer(),
                    this._theme = this.options.theme,
                    this.options.theme = null,
                    this.viewport = new h.Viewport(this, this._viewportElement, this._viewportScrollArea, this.charMeasure),
                    ...
                    this.register(this.addDisposableListener("blur",
                    function() {
                        return t.renderer.onBlur()
                    })),
                    this.register(this.addDisposableListener("focus",
                    function() {
                        return t.renderer.onFocus()
                    })),
                    this.register(this.addDisposableListener("dprchange",
                    function() {
                        return t.renderer.onWindowResize(window.devicePixelRatio)
                    })),
                    this.register(g.addDisposableDomListener(window, "resize",
                    function() {
                        return t.renderer.onWindowResize(window.devicePixelRatio)
                    })),
                    ...
                    this.register(this.renderer.onCanvasResize(function() {
                        return t.viewport.syncScrollArea()
                    })),
                    this.selectionManager = new p.SelectionManager(this, this.charMeasure),
                    this.register(this.selectionManager.onSelectionChange(function() {
                        return t._onSelectionChange.fire()
                    })),
                    this.register(g.addDisposableDomListener(this.element, "mousedown",
                    function(e) {
                    ...
                    this.register(this.onScroll(function() {
                        ...
                        t.selectionManager.refresh()
                    })),
                    this.register(g.addDisposableDomListener(this._viewportElement, "scroll",
                    function() {
                        return t.selectionManager.refresh()
                    })),
                    this.mouseHelper = new v.MouseHelper(this.renderer),
                    this.element.classList.toggle("enable-mouse-events", this.mouseEvents),
                    this.mouseEvents ? this.selectionManager.disable() : this.selectionManager.enable(),
                    this.options.screenReaderMode && (this._accessibilityManager = new S.AccessibilityManager(this)),
                ...
                e.prototype._setupRenderer = function() {
                    ...
                    case "canvas":
                        this.renderer = new _.Renderer(this, this.options.theme);
                        break;
                    case "dom":
                        this.renderer = new A.DomRenderer(this, this.options.theme);
                        break;
                    default:
                        throw new Error('Unrecognized rendererType "' + this.options.rendererType + '"')
                    }
                    this.renderer.onRender(function(e) {
                        return t._onRender.fire(e)
                    }),
                    this.register(this.renderer)
                },
                e.prototype._setTheme = function(e) {
                    this._theme = e;
                ...
                e.prototype.bindMouse = function() {
                    ...
                    function a(e) {
                        ...
                        if (t = function(e) {
                            ...
                            case "mousedown":
                                t = null !== e.button && void 0 !== e.button ? +e.button: null !== e.which && void 0 !== e.which ? e.which - 1 : null,
                            ...
                            return t = 32 + (s << 2) + t
                        } (e), i = o.mouseHelper.getRawByteCoords(e, o.screenElement, o.charMeasure, o.cols, o.rows)) switch (h(t, i), e.overrideType || e.type) {
                        case "mousedown":
                            n = t;
                            break;
                        case "mouseup":
                    ...
                    function h(e, t) {
                        ...
                        if (o._decLocator) return e &= 3,
                        t.x -= 32,
                        t.y -= 32,
                        0 === e ? e = 2 : 1 === e ? e = 4 : 2 === e ? e = 6 : 3 === e && (e = 3),
                        void o.handler(u.C0.ESC + "[" + e + ";" + (3 === e ? 4 : 0) + ";" + t.y + ";" + t.x + ";" + t.page || "0&w");
                        if (o.urxvtMouse) return t.x -= 32,
                        t.y -= 32,
                        t.x++,
                        t.y++,
                        void o.handler(u.C0.ESC + "[" + e + ";" + t.x + ";" + t.y + "M");
                        if (o.sgrMouse) return t.x -= 32,
                        t.y -= 32,
                        void o.handler(u.C0.ESC + "[<" + ((3 == (3 & e) ? -4 & e: e) - 32) + ";" + t.x + ";" + t.y + (3 == (3 & e) ? "m": "M"));
                        var r = [];
                        l(r, e),
                        l(r, t.x),
                        l(r, t.y),
                        o.handler(u.C0.ESC + "[M" + String.fromCharCode.apply(String, r))
                    }
                    this.register(g.addDisposableDomListener(e, "mousedown",
                    function(e) {
                        if (e.preventDefault(), s.focus(), s.mouseEvents && !s.selectionManager.shouldForceSelection(e)) {
                            if (a(e), s.vt200Mouse) return e.overrideType = "mouseup",
                            a(e),
                            s.cancel(e);
                            var t;
                            s.normalMouse && (t = function(e) {
                                var t, i, r;
                                s.normalMouse && (t = e, i = n, (r = o.mouseHelper.getRawByteCoords(t, o.screenElement, o.charMeasure, o.cols, o.rows)) && h(i += 32, r))
                            },
                            s._document.addEventListener("mousemove", t));
                            var i = function(e) {
                                return s.normalMouse && !s.x10Mouse && a(e),
                                t && (s._document.removeEventListener("mousemove", t), t = null),
                    ...
                    this.register(g.addDisposableDomListener(e, "wheel",
                    function(e) {
                        if (s.mouseEvents) s.x10Mouse || s._vt300Mouse || s._decLocator || (a(e), e.preventDefault());
                        else if (!s.buffer.hasScrollback) {
                            var t = s.viewport.getLinesScrolled(e);
                            if (0 === t) return;
                            for (var i = u.C0.ESC + (s.applicationCursor ? "O": "[") + (e.deltaY < 0 ? "A": "B"), r = "", n = 0; n < Math.abs(t); n++) r += i;
                            s.handler(r)
                        }
                    })),
                    this.register(g.addDisposableDomListener(e, "wheel",
                    function(e) {
                        if (!s.mouseEvents) return s.viewport.onWheel(e),
                        s.cancel(e)
                    })),
                    this.register(g.addDisposableDomListener(e, "touchstart",
                    function(e) {
                        if (!s.mouseEvents) return s.viewport.onTouchStart(e),
                        s.cancel(e)
                    })),
                    this.register(g.addDisposableDomListener(e, "touchmove",
                    function(e) {
                        if (!s.mouseEvents) return s.viewport.onTouchMove(e),
                        s.cancel(e)
                    }))
                },
                ...
                e.prototype._queueLinkification = function(e, t) {
                    this.linkifier && this.linkifier.linkifyRows(e, t)
                },
                e.prototype.updateCursorStyle = function(e) {
                ...
                e.prototype.scroll = function(e) {
                    ...
                    t && t.length === this.cols && t.getFg(0) === i.fg && t.getBg(0) === i.bg || (t = this.buffer.getBlankLine(i, e), this._blankLine = t),
                    t.isWrapped = e;
                    ...
                    if (0 === this.buffer.scrollTop) {
                        ...
                        n === this.buffer.lines.length - 1 ? s ? this.buffer.lines.recycle().copyFrom(t) : this.buffer.lines.push(t.clone()) : this.buffer.lines.splice(n + 1, 0, t.clone()),
                        s ? this._userScrolling && (this.buffer.ydisp = Math.max(this.buffer.ydisp - 1, 0)) : (this.buffer.ybase++, this._userScrolling || this.buffer.ydisp++)
                    } else {
                        var o = n - r + 1;
                ...
                e.prototype.scrollLines = function(e, t) {
                    if (e < 0) {
                    ...
                    this.buffer.ydisp = Math.max(Math.min(this.buffer.ydisp + e, this.buffer.ybase), 0),
                    i !== this.buffer.ydisp && (t || this._onScroll.fire(this.buffer.ydisp), this.refresh(0, this.rows - 1))
                },
                ...
                e.prototype.write = function(e) {
                    var t = this;
                    this._isDisposed || e && (this.writeBuffer.push(e), this.options.useFlowControl && !this._xoffSentToCatchUp && 5 <= this.writeBuffer.length && (this.handler(u.C0.DC3), this._xoffSentToCatchUp = !0), !this._writeInProgress && 0 < this.writeBuffer.length && (this._writeInProgress = !0, setTimeout(function() {
                        t._innerWrite()
                    })))
                },
                e.prototype._innerWrite = function(e) {
                    var t = this;
                    void 0 === e && (e = 0),
                    this._isDisposed && (this.writeBuffer = []);
                    for (var i = Date.now(); this.writeBuffer.length > e;) {
                        var r = this.writeBuffer[e];
                        if (e++, this._xoffSentToCatchUp && this.writeBuffer.length === e && (this.handler(u.C0.DC1), this._xoffSentToCatchUp = !1), this._refreshStart = this.buffer.y, this._refreshEnd = this.buffer.y, this._inputHandler.parse(r), this.updateRange(this.buffer.y), this.refresh(this._refreshStart, this._refreshEnd), 12 <= Date.now() - i) break
                    }
                ...
                e.prototype._keyDown = function(e) {
                    ...
                    if (!this._compositionHelper.keydown(e)) return this.buffer.ybase !== this.buffer.ydisp && this.scrollToBottom(),
                    !1;
                    var t = x.evaluateKeyboardEvent(e, this.applicationCursor, this.browser.isMac, this.options.macOptionIsMeta);
                    if (this.updateCursorStyle(e), 3 !== t.type && 2 !== t.type) return 1 === t.type && this.selectAll(),
                    !!this._isThirdLevelShift(this.browser, e) || (t.cancel && this.cancel(e, !0), !t.key || (this.emit("keydown", e), this._onKey.fire({
                        key: t.key,
                        domEvent: e
                ...
                e.prototype._isThirdLevelShift = function(e, t) {
                    ...
                    return "keypress" === t.type ? i: i && (!t.keyCode || 47 < t.keyCode)
                },
                e.prototype.setgLevel = function(e) {
                    this.glevel = e,
                ...
                e.prototype.bell = function() {
                    ...
                    this._visualBell() && (this.element.classList.add("visual-bell-active"), clearTimeout(this._visualBellTimer), this._visualBellTimer = window.setTimeout(function() {
                ...
                e.prototype.clear = function() {
                    if (0 !== this.buffer.ybase || 0 !== this.buffer.y) {
                        ...
                        this.buffer.ybase = 0,
                        this.buffer.y = 0;
                        for (var e = 1; e < this.rows; e++) this.buffer.lines.push(this.buffer.getBlankLine(o.DEFAULT_ATTR_DATA));
                        this.refresh(0, this.rows - 1),
                        this._onScroll.fire(this.buffer.ydisp)
                    }
                },
                ...
                e.prototype.reverseIndex = function() {
                    if (this.buffer.y === this.buffer.scrollTop) {
                        ...
                        this.buffer.lines.shiftElements(this.buffer.y + this.buffer.ybase, e, 1),
                ...
                e.prototype.cancel = function(e, t) {
                    if (this.options.cancelEvents || t) return e.preventDefault(),
                    e.stopPropagation(),
                    !1
                },
        ...
        },
        {
            ...
            "./WindowsMode": 21,
            "./common/Clone": 23,
            "./common/EventEmitter": 24,
            "./common/EventEmitter2": 25,
            "./common/Platform": 27,
            "./common/data/EscapeSequences": 29,
            "./core/input/Keyboard": 31,
            "./renderer/Renderer": 41,
            "./renderer/atlas/CharAtlasCache": 45,
            "./renderer/dom/DomRenderer": 53,
            "./ui/Lifecycle": 55,
            "./ui/ScreenDprMonitor": 57
        }],
        20 : [function(e, t, i) {
            "use strict";
            var r, n = this && this.__extends || (r = function(e, t) {
            ...
            a = function(s) {
                function e(e, t, i, r) {
                    ...
                    n.scrollBarWidth = n._viewportElement.offsetWidth - n._scrollArea.offsetWidth || 15,
                    n.register(o.addDisposableDomListener(n._viewportElement, "scroll", n._onScroll.bind(n))),
                    setTimeout(function() {
                ...
                return n(e, s),
                e.prototype.onThemeChanged = function(e) {
                ...
                e.prototype._innerRefresh = function() {
                    ...
                    this._viewportElement.scrollTop !== t && (this._ignoreNextScrollEvent = !0, this._viewportElement.scrollTop = t),
                    this._refreshAnimationFrame = null
                },
                ...
                e.prototype._onScroll = function(e) {
                    if (this._lastScrollTop = this._viewportElement.scrollTop, this._viewportElement.offsetParent) if (this._ignoreNextScrollEvent) this._ignoreNextScrollEvent = !1;
                    else {
                ...
                e.prototype._getPixelsScrolled = function(e) {
                    ...
                    var t = e.deltaY;
                    return e.deltaMode === WheelEvent.DOM_DELTA_LINE ? t *= this._currentRowHeight: e.deltaMode === WheelEvent.DOM_DELTA_PAGE && (t *= this._currentRowHeight * this._terminal.rows),
                    t
                },
                e.prototype.getLinesScrolled = function(e) {
                    if (0 === e.deltaY) return 0;
                    var t = e.deltaY;
                    return e.deltaMode === WheelEvent.DOM_DELTA_PIXEL ? (t /= this._currentRowHeight + 0, this._wheelPartialScroll += t, t = Math.floor(Math.abs(this._wheelPartialScroll)) * (0 < this._wheelPartialScroll ? 1 : -1), this._wheelPartialScroll %= 1) : e.deltaMode === WheelEvent.DOM_DELTA_PAGE && (t *= this._terminal.rows),
                    t
                },
        ...
        21 : [function(e, t, i) {
            ...
            i.applyWindowsMode = function(t) {
                return t.onLineFeed(function() {
                    var e = t.buffer.lines.get(t.buffer.ybase + t.buffer.y - 1).get(t.cols - 1);
                    e[r.CHAR_DATA_CODE_INDEX] !== r.NULL_CELL_CODE && e[r.CHAR_DATA_CODE_INDEX] !== r.WHITESPACE_CELL_CODE && (t.buffer.lines.get(t.buffer.ybase + t.buffer.y).isWrapped = !0)
                })
            }
        },
        {
        ...
        22 : [function(e, t, i) {
            ...
            n = function() {
                ...
                e.prototype.push = function(e) {
                    ...
                    this._length === this._maxLength ? (this._startIndex = ++this._startIndex % this._maxLength, this.onTrimEmitter.fire(1)) : this._length++
                },
                ...
                e.prototype.splice = function(e, t) {
                    ...
                    for (n = this._length - 1; e <= n; n--) this._array[this._getCyclicIndex(n + i.length)] = this._array[this._getCyclicIndex(n)];
                ...
                e.prototype.shiftElements = function(e, t, i) {
                    if (! (t <= 0)) {
                        ...
                        if (0 < i) {
                            for (var r = t - 1; 0 <= r; r--) this.set(e + r + i, this.get(e + r));
                            var n = e + t + i - this._length;
                            if (0 < n) for (this._length += n; this._length > this._maxLength;) this._length--,
                            this._startIndex++,
                            this.onTrimEmitter.fire(1)
        ...
        24 : [function(e, t, i) {
            ...
            var s = function(t) {
                ...
                e.prototype.emitMayRemoveListeners = function(e) {
                    for (var t = [], i = 1; i < arguments.length; i++) t[i - 1] = arguments[i];
                    if (this._events[e]) for (var r = this._events[e], n = r.length, s = 0; s < r.length; s++) r[s].apply(this, t),
                    s -= n - r.length,
                    n = r.length
                },
        ...
        25 : [function(e, t, i) {
            ...
            var r = function() {
                ...
                return Object.defineProperty(e.prototype, "event", {
                    get: function() {
                        ...
                        return this._event || (this._event = function(t) {
                            return i._listeners.push(t),
                            {
                                dispose: function() {
                                    for (var e = 0; e < i._listeners.length; e++) if (i._listeners[e] === t) return void i._listeners.splice(e, 1)
                                }
                            }
                        }),
                        this._event
                ...
                e.prototype.fire = function(e) {
                    for (var t = [], i = 0; i < this._listeners.length; i++) t.push(this._listeners[i]);
        ...
        31 : [function(e, t, i) {
            ...
            i.evaluateKeyboardEvent = function(e, t, i, r) {
                ...
                switch (e.keyCode) {
                case 0:
                    "UIKeyInputUpArrow" === e.key ? n.key = t ? h.C0.ESC + "OA": h.C0.ESC + "[A": "UIKeyInputLeftArrow" === e.key ? n.key = t ? h.C0.ESC + "OD": h.C0.ESC + "[D": "UIKeyInputRightArrow" === e.key ? n.key = t ? h.C0.ESC + "OC": h.C0.ESC + "[C": "UIKeyInputDownArrow" === e.key && (n.key = t ? h.C0.ESC + "OB": h.C0.ESC + "[B");
                    break;
                case 8:
                    if (e.shiftKey) {
                        n.key = h.C0.BS;
                ...
                case 27:
                    ...
                    break;
                case 37:
                    s ? (n.key = h.C0.ESC + "[1;" + (s + 1) + "D", n.key === h.C0.ESC + "[1;3D" && (n.key = i ? h.C0.ESC + "b": h.C0.ESC + "[1;5D")) : n.key = t ? h.C0.ESC + "OD": h.C0.ESC + "[D";
                    break;
                case 39:
                    s ? (n.key = h.C0.ESC + "[1;" + (s + 1) + "C", n.key === h.C0.ESC + "[1;3C" && (n.key = i ? h.C0.ESC + "f": h.C0.ESC + "[1;5C")) : n.key = t ? h.C0.ESC + "OC": h.C0.ESC + "[C";
                    break;
                case 38:
                    s ? (n.key = h.C0.ESC + "[1;" + (s + 1) + "A", n.key === h.C0.ESC + "[1;3A" && (n.key = h.C0.ESC + "[1;5A")) : n.key = t ? h.C0.ESC + "OA": h.C0.ESC + "[A";
                    break;
                case 40:
                    s ? (n.key = h.C0.ESC + "[1;" + (s + 1) + "B", n.key === h.C0.ESC + "[1;3B" && (n.key = h.C0.ESC + "[1;5B")) : n.key = t ? h.C0.ESC + "OB": h.C0.ESC + "[B";
                    break;
                case 45:
                ...
                case 46:
                    ...
                    break;
                case 36:
                    n.key = s ? h.C0.ESC + "[1;" + (s + 1) + "H": t ? h.C0.ESC + "OH": h.C0.ESC + "[H";
                    break;
                case 35:
                    n.key = s ? h.C0.ESC + "[1;" + (s + 1) + "F": t ? h.C0.ESC + "OF": h.C0.ESC + "[F";
                    break;
                case 33:
                ...
                case 123:
                    ...
                    break;
                default:
                    if (!e.ctrlKey || e.shiftKey || e.altKey || e.metaKey) if (i && !r || !e.altKey || e.metaKey) i && !e.altKey && !e.ctrlKey && e.metaKey ? 65 === e.keyCode && (n.type = 1) : e.key && !e.ctrlKey && !e.altKey && !e.metaKey && 48 <= e.keyCode && 1 === e.key.length && (n.key = e.key);
                    else {
                        var o = c[e.keyCode],
                    ...
                    } else 65 <= e.keyCode && e.keyCode <= 90 ? n.key = String.fromCharCode(e.keyCode - 64) : 32 === e.keyCode ? n.key = String.fromCharCode(0) : 51 <= e.keyCode && e.keyCode <= 55 ? n.key = String.fromCharCode(e.keyCode - 51 + 27) : 56 === e.keyCode ? n.key = String.fromCharCode(127) : 219 === e.keyCode ? n.key = String.fromCharCode(27) : 220 === e.keyCode ? n.key = String.fromCharCode(28) : 221 === e.keyCode && (n.key = String.fromCharCode(29))
                }
                return n
            }
        },
        ...
        32 : [function(e, t, i) {
            ...
            var r = function() {
                ...
                e.prototype.decode = function(e, t) {
                    ...
                    if (this._interim) {
                        ...
                        t[r++] = 56320 <= s && s <= 57343 ? 1024 * (this._interim - 55296) + s - 56320 + 65536 : (t[r++] = this._interim, s),
                        this._interim = 0
                    }
                    for (var o = n; o < i; ++o) {
                        var a = e.charCodeAt(o);
                        if (55296 <= a && a <= 56319) {
                            if (++o >= i) return this._interim = a,
                            r;
                            s = e.charCodeAt(o);
                            t[r++] = 56320 <= s && s <= 57343 ? 1024 * (a - 55296) + s - 56320 + 65536 : (t[r++] = a, s)
                        } else t[r++] = a
                    }
                    return r
                },
            ...
            i.stringFromCodePoint = function(e) {
                return 65535 < e ? (e -= 65536, String.fromCharCode(55296 + (e >> 10)) + String.fromCharCode(e % 1024 + 56320)) : String.fromCharCode(e)
            },
            i.utf32ToString = function(e, t, i) {
                ...
                n = t; n < i; ++n) {
                    var s = e[n];
                    65535 < s ? (s -= 65536, r += String.fromCharCode(55296 + (s >> 10)) + String.fromCharCode(s % 1024 + 56320)) : r += String.fromCharCode(s)
                }
                return r
            }
        },
        ...
        33 : [function(e, t, i) {
            ...
            n = function() {
                ...
                e.prototype._moveToRequestedCol = function() {
                    var e;
                    e = 0 < this._moveToRequestedRow().length ? this._endRow - this._wrappedRowsForRow(this._endRow) : this._startRow;
                    var t = this._endRow,
                ...
                e.prototype._wrappedRowsCount = function() {
                    for (var e = 0,
                    t = this._startRow - this._wrappedRowsForRow(this._startRow), i = this._endRow - this._wrappedRowsForRow(this._endRow), r = 0; r < Math.abs(t - i); r++) {
                ...
                e.prototype._wrappedRowsForRow = function(e) {
                    for (var t = 0,
                    i = this._lines.get(e).isWrapped; i && 0 <= e && e < this._terminal.rows;) t++,
                    e--,
                    i = this._lines.get(e).isWrapped;
                    return t
                },
                e.prototype._horizontalDirection = function() {
                    var e;
                    return e = 0 < this._moveToRequestedRow().length ? this._endRow - this._wrappedRowsForRow(this._endRow) : this._startRow,
                    this._startCol < this._endCol && e <= this._endRow || this._startCol >= this._endCol && e < this._endRow ? "C": "D"
                },
                ...
                e.prototype._bufferLine = function(e, t, i, r, n) {
                    ...
                    o = t,
                    a = ""; s !== i || o !== r;) s += n ? 1 : -1,
                    n && s > this._terminal.cols - 1 ? (a += this._terminal.buffer.translateBufferLineToString(o, !1, e, s), e = s = 0, o++) : !n && s < 0 && (a += this._terminal.buffer.translateBufferLineToString(o, !1, 0, e + 1), e = s = this._terminal.cols - 1, o--);
        ...
        34 : [function(e, t, i) {
            ...
            s = function() {
                ...
                return Object.defineProperty(t.prototype, "onCursorMove", {
                    get: function() {
        ...
        35 : [function(e, t, i) {
            ...
            n = function() {
                ...
                e.prototype.fillBottomLineAtCells = function(e, t, i) {
                    void 0 === i && (i = 1),
                    this._ctx.fillRect(e * this._scaledCellWidth, (t + 1) * this._scaledCellHeight - window.devicePixelRatio - 1, i * this._scaledCellWidth, window.devicePixelRatio)
                },
                ...
                e.prototype.strokeRectAtCell = function(e, t, i, r) {
                    ...
                    this._ctx.strokeRect(e * this._scaledCellWidth + window.devicePixelRatio / 2, t * this._scaledCellHeight + window.devicePixelRatio / 2, i * this._scaledCellWidth - window.devicePixelRatio, r * this._scaledCellHeight - window.devicePixelRatio)
                },
                ...
                e.prototype.fillCharTrueColor = function(e, t, i, r) {
                    ...
                    this._clipRow(e, r),
                    this._ctx.fillText(t.getChars(), i * this._scaledCellWidth + this._scaledCharLeft, r * this._scaledCellHeight + this._scaledCharTop + this._scaledCharHeight / 2)
                },
                e.prototype.drawChars = function(e, t, i, r) {
                    var n, s;
                    t.isFgRGB() || t.isBgRGB() ? this._drawUncachedChars(e, t, i, r) : (t.isInverse() ? (n = t.isBgDefault() ? o.INVERTED_DEFAULT_COLOR: t.getBgColor(), s = t.isFgDefault() ? o.INVERTED_DEFAULT_COLOR: t.getFgColor()) : (s = t.isBgDefault() ? o.DEFAULT_COLOR: t.getBgColor(), n = t.isFgDefault() ? o.DEFAULT_COLOR: t.getFgColor()), n += e.options.drawBoldTextInBrightColors && t.isBold() && n < 8 && n !== o.INVERTED_DEFAULT_COLOR ? 8 : 0, this._currentGlyphIdentifier.chars = t.getChars() || a.WHITESPACE_CELL_CHAR, this._currentGlyphIdentifier.code = t.getCode() || a.WHITESPACE_CELL_CODE, this._currentGlyphIdentifier.bg = s, this._currentGlyphIdentifier.fg = n, this._currentGlyphIdentifier.bold = t.isBold() && e.options.enableBold, this._currentGlyphIdentifier.dim = !!t.isDim(), this._currentGlyphIdentifier.italic = !!t.isItalic(), this._charAtlas && this._charAtlas.draw(this._ctx, this._currentGlyphIdentifier, i * this._scaledCellWidth + this._scaledCharLeft, r * this._scaledCellHeight + this._scaledCharTop) || this._drawUncachedChars(e, t, i, r))
                },
                e.prototype._drawUncachedChars = function(e, t, i, r) {
                    if (this._ctx.save(), this._ctx.font = this._getFont(e, t.isBold() && e.options.enableBold, !!t.isItalic()), this._ctx.textBaseline = "middle", t.isInverse()) t.isBgDefault() ? this._ctx.fillStyle = this._colors.background.css: t.isBgRGB() ? this._ctx.fillStyle = "rgb(" + s.AttributeData.toColorRGB(t.getBgColor()).join(",") + ")": this._ctx.fillStyle = this._colors.ansi[t.getBgColor()].css;
                        ...
                        var n = t.getFgColor();
                        e.options.drawBoldTextInBrightColors && t.isBold() && n < 8 && (n += 8),
                        this._ctx.fillStyle = this._colors.ansi[n].css
                    }
                    this._clipRow(e, r),
                    t.isDim() && (this._ctx.globalAlpha = o.DIM_OPACITY),
                    this._ctx.fillText(t.getChars(), i * this._scaledCellWidth + this._scaledCharLeft, r * this._scaledCellHeight + this._scaledCharTop + this._scaledCharHeight / 2),
                    this._ctx.restore()
                },
                e.prototype._clipRow = function(e, t) {
                    this._ctx.beginPath(),
                    this._ctx.rect(0, t * this._scaledCellHeight, e.cols * this._scaledCellWidth, this._scaledCellHeight),
                    this._ctx.clip()
                },
        ...
        36 : [function(e, t, i) {
            ...
            n = function() {
                ...
                c.prototype.deregisterCharacterJoiner = function(e) {
                    for (var t = 0; t < this._characterJoiners.length; t++) if (this._characterJoiners[t].id === e) return this._characterJoiners.splice(t, 1),
                    !0;
                    return ! 1
                },
                c.prototype.getJoinedCharacters = function(e) {
                    ...
                    for (var i = [], r = t.translateToString(!0), n = 0, s = 0, o = 0, a = t.getFg(0), l = t.getBg(0), h = 0; h < t.getTrimmedLength(); h++) if (t.loadCell(h, this._workCell), 0 !== this._workCell.getWidth()) {
                        if (this._workCell.fg !== a || this._workCell.bg !== l) {
                            if (1 < h - n) for (var c = this._getJoinedRanges(r, o, s, t, n), u = 0; u < c.length; u++) i.push(c[u]);
                            n = h,
                            o = s,
                            a = this._workCell.fg,
                            l = this._workCell.bg
                        }
                        s += this._workCell.getChars().length || f.WHITESPACE_CELL_CHAR.length
                    }
                    if (1 < this._terminal.cols - n) for (c = this._getJoinedRanges(r, o, s, t, n), u = 0; u < c.length; u++) i.push(c[u]);
                    return i
                },
                c.prototype._getJoinedRanges = function(e, t, i, r, n) {
                    for (var s = e.substring(t, i), o = this._characterJoiners[0].handler(s), a = 1; a < this._characterJoiners.length; a++) for (var l = this._characterJoiners[a].handler(s), h = 0; h < l.length; h++) c._mergeRanges(o, l[h]);
                    return this._stringRangesToCellRanges(o, r, n),
                    o
                },
                ...
                c._mergeRanges = function(e, t) {
                    ...
                    r = 0; r < e.length; r++) {
                        var n = e[r];
                        if (i) {
                            if (t[1] <= n[0]) return e[r - 1][1] = t[1],
                            e;
                            if (t[1] <= n[1]) return e[r - 1][1] = Math.max(t[1], n[1]),
                            e.splice(r, 1),
                            i = !1,
                            e;
                            e.splice(r, 1),
                            ...
                            if (t[1] <= n[0]) return e.splice(r, 0, t),
                            e;
                            if (t[1] <= n[1]) return n[0] = Math.min(t[0], n[0]),
                            e;
        ...
        37 : [function(e, t, r) {
            ...
            r.DEFAULT_ANSI_COLORS = function() {
                for (var e = [h("#2e3436"), h("#cc0000"), h("#4e9a06"), h("#c4a000"), h("#3465a4"), h("#75507b"), h("#06989a"), h("#d3d7cf"), h("#555753"), h("#ef2929"), h("#8ae234"), h("#fce94f"), h("#729fcf"), h("#ad7fa8"), h("#34e2e2"), h("#eeeeec")], t = [0, 95, 135, 175, 215, 255], i = 0; i < 216; i++) {
                    var r = t[i / 36 % 6 | 0],
                    n = t[i / 6 % 6 | 0],
                    s = t[i % 6];
                    e.push({
            ...
            var i = function() {
                ...
                return e.prototype.setTheme = function(e) {
                    this.colors.foreground = this._parseColor(e.foreground, n),
                    ...
                    this.colors.ansi[5] = this._parseColor(e.magenta, r.DEFAULT_ANSI_COLORS[5]),
                    ...
                    this.colors.ansi[8] = this._parseColor(e.brightBlack, r.DEFAULT_ANSI_COLORS[8]),
                    this.colors.ansi[9] = this._parseColor(e.brightRed, r.DEFAULT_ANSI_COLORS[9]),
                    this.colors.ansi[10] = this._parseColor(e.brightGreen, r.DEFAULT_ANSI_COLORS[10]),
                    this.colors.ansi[11] = this._parseColor(e.brightYellow, r.DEFAULT_ANSI_COLORS[11]),
                    this.colors.ansi[12] = this._parseColor(e.brightBlue, r.DEFAULT_ANSI_COLORS[12]),
                    this.colors.ansi[13] = this._parseColor(e.brightMagenta, r.DEFAULT_ANSI_COLORS[13]),
                    this.colors.ansi[14] = this._parseColor(e.brightCyan, r.DEFAULT_ANSI_COLORS[14]),
                    this.colors.ansi[15] = this._parseColor(e.brightWhite, r.DEFAULT_ANSI_COLORS[15])
                },
                e.prototype._parseColor = function(e, t, i) {
                    if (void 0 === i && (i = this.allowTransparency), !e) return t;
                    if (this._ctx.fillStyle = this._litmusColor, this._ctx.fillStyle = e, "string" != typeof this._ctx.fillStyle) return console.warn("Color: " + e + " is invalid using fallback " + t.css),
                    t;
        ...
        38 : [function(e, t, i) {
            ...
            var n = e("./BaseRenderLayer"),
            o = e("../BufferLine"),
            a = function(n) {
                function e(e, t, i) {
                    var r = n.call(this, e, "cursor", t, !0, i) || this;
                    return r._cell = new o.CellData,
                    r._state = {
                        x: null,
                        y: null,
                        isFocused: null,
                ...
                return s(e, n),
                e.prototype.resize = function(e, t) {
                    n.prototype.resize.call(this, e, t),
                    this._state = {
                        x: null,
                        y: null,
                        isFocused: null,
                ...
                e.prototype.reset = function(e) {
                    this._clearCursor(),
                    this._cursorBlinkStateManager && (this._cursorBlinkStateManager.dispose(), this._cursorBlinkStateManager = null, this.onOptionsChanged(e))
                },
                e.prototype.onBlur = function(e) {
                ...
                e.prototype.onOptionsChanged = function(e) {
                    var t = this;
                    e.options.cursorBlink ? this._cursorBlinkStateManager || (this._cursorBlinkStateManager = new l(e,
                    function() {
                        t._render(e, !0)
                ...
                e.prototype.onGridChanged = function(e, t, i) { ! this._cursorBlinkStateManager || this._cursorBlinkStateManager.isPaused ? this._render(e, !1) : this._cursorBlinkStateManager.restartBlinkAnimation(e)
                },
                e.prototype._render = function(e, t) {
                    if (e.cursorState && !e.cursorHidden) {
                        ...
                        if (r < 0 || r >= e.rows) this._clearCursor();
                        else if (e.buffer.lines.get(i).loadCell(e.buffer.x, this._cell), void 0 !== this._cell.content) {
                            if (!e.isFocused) return this._clearCursor(),
                            this._ctx.save(),
                            ...
                            if (!this._cursorBlinkStateManager || this._cursorBlinkStateManager.isCursorVisible) {
                                if (this._state) {
                                    if (this._state.x === e.buffer.x && this._state.y === r && this._state.isFocused === e.isFocused && this._state.style === e.options.cursorStyle && this._state.width === this._cell.getWidth()) return;
                                    this._clearCursor()
                                }
                                this._ctx.save(),
                                this._cursorRenderers[e.options.cursorStyle || "block"](e, e.buffer.x, r, this._cell),
                                this._ctx.restore(),
                                this._state.x = e.buffer.x,
                                this._state.y = r,
                                this._state.isFocused = !1,
                ...
                e.prototype._restartInterval = function(e) {
                    ...
                    this._blinkStartTimeout = setTimeout(function() {
                        if (t._animationTimeRestarted) {
                            ...
                            if (t._animationTimeRestarted = null, 0 < e) return void t._restartInterval(e)
                        }
                        t.isCursorVisible = !1,
            ...
            l = function(s) {
                ...
                e.prototype._clearCurrentLink = function() {
                    if (this._state) {
                        ...
                        0 < e && this.clearCells(0, this._state.y1 + 1, this._state.cols, e),
                        this.clearCells(0, this._state.y2, this._state.x2, 1),
                        this._state = null
                    }
                },
                e.prototype._onLinkHover = function(e) {
                    if (e.fg === o.INVERTED_DEFAULT_COLOR ? this._ctx.fillStyle = this._colors.background.css: a.is256Color(e.fg) ? this._ctx.fillStyle = this._colors.ansi[e.fg].css: this._ctx.fillStyle = this._colors.foreground.css, e.y1 === e.y2) this.fillBottomLineAtCells(e.x1, e.y1, e.x2 - e.x1);
                    else {
        ...
        41 : [function(e, t, i) {
            ...
            var o = e("./TextRenderLayer"),
            a = e("./SelectionRenderLayer"),
            l = e("./CursorRenderLayer"),
            h = e("./ColorManager"),
            c = e("./LinkRenderLayer"),
            u = e("../ui/RenderDebouncer"),
            f = e("../ui/ScreenDprMonitor"),
            _ = e("../renderer/CharacterJoinerRegistry"),
            d = e("../common/EventEmitter2"),
            s = function(s) {
                function e(e, t) {
                    var i = s.call(this) || this;
                    i._terminal = e,
                    i._isPaused = !1,
                    i._needsFullRefresh = !1,
                    i._onCanvasResize = new d.EventEmitter2,
                    i._onRender = new d.EventEmitter2;
                    var r = i._terminal.options.allowTransparency;
                    if (i.colorManager = new h.ColorManager(document, r), i._characterJoinerRegistry = new _.CharacterJoinerRegistry(e), t && i.colorManager.setTheme(t), i._renderLayers = [new o.TextRenderLayer(i._terminal.screenElement, 0, i.colorManager.colors, i._characterJoinerRegistry, r), new a.SelectionRenderLayer(i._terminal.screenElement, 1, i.colorManager.colors), new c.LinkRenderLayer(i._terminal.screenElement, 2, i.colorManager.colors, i._terminal), new l.CursorRenderLayer(i._terminal.screenElement, 3, i.colorManager.colors)], i.dimensions = {
                    ...
                    i._devicePixelRatio = window.devicePixelRatio, i._updateDimensions(), i.onOptionsChanged(), i._renderDebouncer = new u.RenderDebouncer(i._renderRows.bind(i)), i._screenDprMonitor = new f.ScreenDprMonitor, i._screenDprMonitor.setListener(function() {
                ...
                return n(e, s),
                Object.defineProperty(e.prototype, "onCanvasResize", {
                    get: function() {
                        return this._onCanvasResize.event
                    },
                    enumerable: !0,
                    configurable: !0
                }),
                ...
                e.prototype.onIntersectionChange = function(e) {
                    ...
                    !this._isPaused && this._needsFullRefresh && (this._terminal.refresh(0, this._terminal.rows - 1), this._needsFullRefresh = !1)
                },
                ...
                e.prototype.refreshRows = function(e, t) {
                    this._isPaused ? this._needsFullRefresh = !0 : this._renderDebouncer.refresh(e, t, this._terminal.rows)
                },
        ...
        },
        {
            "../common/EventEmitter2": 25,
            "../common/Lifecycle": 26,
            "../renderer/CharacterJoinerRegistry": 36,
            "../ui/RenderDebouncer": 56,
            "../ui/ScreenDprMonitor": 57,
            "./ColorManager": 37,
            "./CursorRenderLayer": 38,
            "./LinkRenderLayer": 40,
            "./SelectionRenderLayer": 42,
            "./TextRenderLayer": 43
        }],
        42 : [function(e, t, i) {
            "use strict";
        ...
        43 : [function(e, t, i) {
            ...
            o = function(o) {
                ...
                e.prototype.resize = function(e, t) {
                    ...
                    this._characterWidth === t.scaledCharWidth && this._characterFont === i || (this._characterWidth = t.scaledCharWidth, this._characterFont = i, this._characterOverlapCache = {}),
                    this._state.clear(),
                ...
                e.prototype._forEachCell = function(e, t, i, r, n) {
                    for (var s = t; s <= i; s++) for (var o = s + e.buffer.ydisp,
                    a = e.buffer.lines.get(o), l = r ? r.getJoinedCharacters(o) : [], h = 0; h < e.cols; h++) {
                        ...
                        if (0 !== c.getWidth()) {
                            if (0 < l.length && h === l[0][0]) {
                                u = !0;
                                var _ = l.shift(); (c = p.CellData.fromCharData([0, a.translateToString(!0, _[0], _[1]), _[1] - _[0], 16777215])).fg = this._workCell.fg,
                                c.bg = this._workCell.bg,
                                f = _[1] - 1
                            } ! u && this._isOverlapping(c) && f < a.length - 1 && a.getCodePoint(f + 1) === d.NULL_CELL_CODE && (c.content &= -12582913, c.content |= 2 << 22),
                            n(c, h, s),
                            h = f
                        }
                    }
                ...
                e.prototype._drawBackground = function(e, t, i) {
                    ...
                    h = null;
                    s.save(),
                    this._forEachCell(e, t, i, null,
                    function(e, t, i) {
                        var r = null;
                        e.isInverse() ? r = e.isFgDefault() ? n._colors.foreground.css: e.isFgRGB() ? "rgb(" + p.AttributeData.toColorRGB(e.getFgColor()).join(",") + ")": n._colors.ansi[e.getFgColor()].css: e.isBgRGB() ? r = "rgb(" + p.AttributeData.toColorRGB(e.getBgColor()).join(",") + ")": e.isBgPalette() && (r = n._colors.ansi[e.getBgColor()].css),
                        null === h && (a = t, l = i),
                        i !== l ? (s.fillStyle = h, n.fillCells(a, l, o - a, 1), a = t, l = i) : h !== r && (s.fillStyle = h, n.fillCells(a, l, t - a, 1), a = t, l = i),
                        h = r
                    }),
                    null !== h && (s.fillStyle = h, this.fillCells(a, l, o - a, 1)),
                    s.restore()
                },
                e.prototype._drawForeground = function(n, e, t) {
                    var s = this;
                    this._forEachCell(n, e, t, this._characterJoinerRegistry,
                    function(e, t, i) {
                        if (!e.isInvisible()) {
                            if (e.isUnderline()) {
                                if (s._ctx.save(), e.isInverse()) e.isBgDefault() ? s._ctx.fillStyle = s._colors.background.css: e.isBgRGB() ? s._ctx.fillStyle = "rgb(" + p.AttributeData.toColorRGB(e.getBgColor()).join(",") + ")": s._ctx.fillStyle = s._colors.ansi[e.getBgColor()].css;
                                else if (e.isFgDefault()) s._ctx.fillStyle = s._colors.foreground.css;
                                else if (e.isFgRGB()) s._ctx.fillStyle = "rgb(" + p.AttributeData.toColorRGB(e.getFgColor()).join(",") + ")";
                                else {
                                    var r = e.getFgColor();
                                    n.options.drawBoldTextInBrightColors && e.isBold() && r < 8 && (r += 8),
                ...
                e.prototype._isOverlapping = function(e) {
                    ...
                    this._characterOverlapCache[t] = i
                },
                e
            } (s.BaseRenderLayer);
            i.TextRenderLayer = o
        ...
        45 : [function(e, t, i) {
            ...
            i.acquireCharAtlas = function(e, t, i, r) {
                for (var n = h.generateConfig(i, r, e, t), s = 0; s < u.length; s++) {
                    ...
                    if (0 <= o) {
                        ...
                        1 === a.ownedBy.length ? (a.atlas.dispose(), u.splice(s, 1)) : a.ownedBy.splice(o, 1);
                        break
                    }
                }
                for (s = 0; s < u.length; s++) {
                    var a = u[s];
                    if (h.configEquals(a.config, n)) return a.ownedBy.push(e),
                    a.atlas
                }
                var l = {
            ...
            i.removeTerminalFromCache = function(e) {
                for (var t = 0; t < u.length; t++) {
                    ...
                    if ( - 1 !== i) {
                        1 === u[t].ownedBy.length ? (u[t].atlas.dispose(), u.splice(t, 1)) : u[t].ownedBy.splice(i, 1);
                        break
                    }
                }
            }
        ...
        46 : [function(e, t, i) {
            ...
            function _(e, t) {
                ...
                n = t.rgba >>> 16 & 255,
                s = t.rgba >>> 8 & 255,
                o = 0; o < e.data.length; o += 4) e.data[o] === r && e.data[o + 1] === n && e.data[o + 2] === s ? e.data[o + 3] = 0 : i = !1;
                return i
            }
            function d(e, t) {
            ...
            i.generateStaticCharAtlasTexture = function(e, t, i) {
                ...
                for (var a = 0; a < 256; a++) o.save(),
                o.beginPath(),
                o.rect(a * r, 0, r, n),
                o.clip(),
                o.fillText(String.fromCharCode(a), a * r, n / 2),
                o.restore();
                for (o.save(), o.font = d(i.fontWeightBold, i), a = 0; a < 256; a++) o.save(),
                o.beginPath(),
                o.rect(a * r, n, r, n),
                o.clip(),
                ...
                for (o.font = d(i.fontWeightBold, i), l = 0; l < 16; l++) for (h = (l + 2 + 16) * n, a = 0; a < 256; a++) o.save(),
                o.beginPath(),
                o.rect(a * r, h, r, n),
                o.clip(),
                o.fillStyle = i.colors.ansi[l].css,
                o.fillText(String.fromCharCode(a), a * r, h + n / 2),
                o.restore();
                if (o.restore(), !("createImageBitmap" in e) || u.isFirefox || u.isSafari) return s;
                var c = o.getImageData(0, 0, s.width, s.height);
                return _(c, i.colors.background),
                e.createImageBitmap(c)
            },
            i.clearColor = _
        },
        {
        ...
        48 : [function(e, t, i) {
            ...
            var _ = function(s) {
                function e(e, t) {
                    ...
                    i._cacheCtx = i._cacheCanvas.getContext("2d", {
                        alpha: !0
                    });
                    ...
                    return i._cacheMap = new a.
                default(n),
                    i._cacheMap.prealloc(n),
                    i
                }
                return n(e, s),
                e.prototype.dispose = function() {
                ...
                e.prototype.draw = function(e, t, i, r) {
                    ...
                    if (null != s) return this._drawFromCache(e, s, i, r),
                    !0;
                ...
                e.prototype._getBackgroundColor = function(e) {
                    return this._config.allowTransparency ? h: e.bg === c.INVERTED_DEFAULT_COLOR ? this._config.colors.foreground: e.bg < 256 ? this._getColorFromAnsiIndex(e.bg) : this._config.colors.background
                },
                e.prototype._getForegroundColor = function(e) {
                    return e.fg === c.INVERTED_DEFAULT_COLOR ? this._config.colors.background: e.fg < 256 ? this._getColorFromAnsiIndex(e.fg) : this._config.colors.foreground
                },
                e.prototype._drawToCache = function(e, t) {
                    ...
                    n = e.italic ? "italic": "";
                    this._tmpCtx.font = n + " " + r + " " + this._config.fontSize * this._config.devicePixelRatio + "px " + this._config.fontFamily,
        ...
        49 : [function(e, t, i) {
            ...
            var r = function() {
                ...
                e.prototype.set = function(e, t) {
                    var i = this._map[e];
                    if (void 0 !== i) i = this._map[e],
                    this._unlinkNode(i),
                    i.value = t;
                    else if (this.size >= this.capacity) i = this._head,
                    this._unlinkNode(i),
                    ...
                    this._map[e] = i;
                        ...
                        0 < r.length ? ((i = r.pop()).key = e, i.value = t) : i = {
                            prev: null,
                            next: null,
                            key: e,
                            value: t
        ...
        51 : [function(e, t, i) {
            ...
            h = function(i) {
                ...
                e.prototype._isCached = function(e, t) {
                    ...
                    s = e.bg === a.DEFAULT_COLOR;
                    return i && (r || n) && s && !e.italic
                },
                e.prototype.draw = function(e, t, i, r) {
                    if (null === this._texture || void 0 === this._texture) return ! 1;
                    var n = 0;
                    if (l.is256Color(t.fg) ? n = 2 + t.fg + (t.bold ? 16 : 0) : t.fg === a.DEFAULT_COLOR && t.bold && (n = 1), !this._isCached(t, n)) return ! 1;
                    e.save();
                    ...
                    e.drawImage(this._texture, t.code * s, n * o, s, this._config.scaledCharHeight, i, r, s, this._config.scaledCharHeight),
                    e.restore(),
                    !0
                },
                e
        ...
        53 : [function(e, t, i) {
            ...
            g = function(n) {
                function e(e, t) {
                    ...
                    i._terminalClass = y++,
                    i._rowElements = [],
                    i._onCanvasResize = new c.EventEmitter2,
                    i._onRender = new c.EventEmitter2;
                    var r = i._terminal.options.allowTransparency;
                    return i.colorManager = new o.ColorManager(document, r),
                    i.setTheme(t),
                    i._rowContainer = document.createElement("div"),
                    i._rowContainer.classList.add(f),
                    ...
                    i._selectionContainer.classList.add(m),
                    ...
                    i._updateDimensions(),
                    i._renderDebouncer = new a.RenderDebouncer(i._renderRows.bind(i)),
                    i._rowFactory = new l.DomRendererRowFactory(e.options, document),
                    i._terminal.element.classList.add(u + i._terminalClass),
                ...
                e.prototype.dispose = function() {
                    this._terminal.element.classList.remove(u + this._terminalClass),
                ...
                e.prototype._updateDimensions = function() {
                    ...
                    var e = this._terminalSelector + " ." + f + " span { display: inline-block; height: 100%; vertical-align: top; width: " + this.dimensions.actualCellWidth + "px}";
                ...
                e.prototype.setTheme = function(e) {
                    ...
                    var r = this._terminalSelector + " ." + f + " { color: " + this.colorManager.colors.foreground.css + "; background-color: " + this.colorManager.colors.background.css + "; font-family: " + this._terminal.getOption("fontFamily") + "; font-size: " + this._terminal.getOption("fontSize") + "px;}";
                    ...
                    r += "@keyframes blink { 0% { opacity: 1.0; } 50% { opacity: 0.0; } 100% { opacity: 1.0; }}",
                    r += this._terminalSelector + " ." + f + ":not(." + p + ") ." + l.CURSOR_CLASS + " { outline: 1px solid " + this.colorManager.colors.cursor.css + "; outline-offset: -1px;}" + this._terminalSelector + " ." + f + "." + p + " ." + l.CURSOR_CLASS + "." + l.CURSOR_BLINK_CLASS + " { animation: blink 1s step-end infinite;}" + this._terminalSelector + " ." + f + "." + p + " ." + l.CURSOR_CLASS + "." + l.CURSOR_STYLE_BLOCK_CLASS + " { background-color: " + this.colorManager.colors.cursor.css + "; color: " + this.colorManager.colors.cursorAccent.css + ";}" + this._terminalSelector + " ." + f + "." + p + " ." + l.CURSOR_CLASS + "." + l.CURSOR_STYLE_BAR_CLASS + " { box-shadow: 1px 0 0 " + this.colorManager.colors.cursor.css + " inset;}" + this._terminalSelector + " ." + f + "." + p + " ." + l.CURSOR_CLASS + "." + l.CURSOR_STYLE_UNDERLINE_CLASS + " { box-shadow: 0 -1px 0 " + this.colorManager.colors.cursor.css + " inset;}",
                    r += this._terminalSelector + " ." + m + " { position: absolute; top: 0; left: 0; z-index: 1; pointer-events: none;}" + this._terminalSelector + " ." + m + " div { position: absolute; background-color: " + this.colorManager.colors.selection.css + ";}",
                    this.colorManager.colors.ansi.forEach(function(e, t) {
                        r += i._terminalSelector + " ." + _ + t + " { color: " + e.css + "; }" + i._terminalSelector + " ." + d + t + " { background-color: " + e.css + "; }"
                    }),
                    r += this._terminalSelector + " ." + _ + h.INVERTED_DEFAULT_COLOR + " { color: " + this.colorManager.colors.background.css + "; }" + this._terminalSelector + " ." + d + h.INVERTED_DEFAULT_COLOR + " { background-color: " + this.colorManager.colors.foreground.css + "; }",
                ...
                e.prototype._refreshRowElements = function(e, t) {
                ...
                e.prototype.onBlur = function() {
                    this._rowContainer.classList.remove(p)
                },
                e.prototype.onFocus = function() {
                    this._rowContainer.classList.add(p)
                },
                e.prototype.onSelectionChanged = function(e, t, i) {
                    ...
                    if (e && t) {
                        ...
                        if (! (s >= this._terminal.rows || o < 0)) {
                            ...
                            if (i) a.appendChild(this._createSelectionElement(s, e[0], t[0], o - s + 1));
                            else {
                                var l = r === s ? e[0] : 0,
                ...
                e.prototype._createSelectionElement = function(e, t, i, r) {
                    void 0 === r && (r = 1);
                    var n = document.createElement("div");
                    return n.style.height = r * this.dimensions.actualCellHeight + "px",
                    n.style.top = e * this.dimensions.actualCellHeight + "px",
                    n.style.left = t * this.dimensions.actualCellWidth + "px",
                    n.style.width = this.dimensions.actualCellWidth * (i - t) + "px",
                    n
                },
                e.prototype.onCursorMove = function() {},
                e.prototype.onOptionsChanged = function() {
                ...
                e.prototype.refreshRows = function(e, t) {
                    this._renderDebouncer.refresh(e, t, this._terminal.rows)
                },
                e.prototype._renderRows = function(e, t) {
                    for (var i = this._terminal,
                    ...
                    o = e; o <= t; o++) {
                        ...
                        a.appendChild(this._rowFactory.createRow(h, l === r, c, n, s, this.dimensions.actualCellWidth, i.cols))
                    }
                    this._onRender.fire({
                        start: e,
                        end: t
        ...
        54 : [function(e, t, p) {
            ...
            var i = function() {
                ...
                return e.prototype.createRow = function(e, t, i, r, n, s, o) {
                    for (var a = this._document.createDocumentFragment(), l = 0, h = Math.min(e.length, o) - 1; 0 <= h; h--) if (e.loadCell(h, this._workCell).getCode() !== m.NULL_CELL_CODE || t && h === r) {
                        l = h + 1;
                        break
                    }
                    for (h = 0; h < l; h++) {
                        ...
                        if (0 !== c) {
                            ...
                            if (1 < c && (u.style.width = s * c + "px"), t && h === r) switch (u.classList.add(p.CURSOR_CLASS), n && u.classList.add(p.CURSOR_BLINK_CLASS), i) {
                            case "bar":
                            ...
                            this._workCell.isBold() && this._terminalOptions.enableBold && u.classList.add(p.BOLD_CLASS),
                            this._workCell.isItalic() && u.classList.add(p.ITALIC_CLASS),
                            this._workCell.isDim() && u.classList.add(p.DIM_CLASS),
                            this._workCell.isUnderline() && u.classList.add(p.UNDERLINE_CLASS),
                            u.textContent = this._workCell.getChars() || m.WHITESPACE_CELL_CHAR;
                            var f = this._workCell.isInverse();
                            if (this._workCell.isFgRGB()) {
                                var _ = u.getAttribute("style") || "";
                                _ += (f ? "background-": "") + "color:rgb(" + g.AttributeData.toColorRGB(this._workCell.getFgColor()).join(",") + ");",
                                u.setAttribute("style", _)
                            } else if (this._workCell.isFgPalette()) {
                                var d = this._workCell.getFgColor();
                                this._workCell.isBold() && d < 8 && !f && this._terminalOptions.enableBold && this._terminalOptions.drawBoldTextInBrightColors && (d += 8),
                                u.classList.add("xterm-" + (f ? "b": "f") + "g-" + d)
                            } else f && u.classList.add("xterm-bg-" + y.INVERTED_DEFAULT_COLOR);
                            if (this._workCell.isBgRGB()) {
                                _ = u.getAttribute("style") || "";
                                _ += (f ? "": "background-") + "color:rgb(" + g.AttributeData.toColorRGB(this._workCell.getBgColor()).join(",") + ");",
                                u.setAttribute("style", _)
                            } else this._workCell.isBgPalette() ? u.classList.add("xterm-" + (f ? "f": "b") + "g-" + this._workCell.getBgColor()) : f && u.classList.add("xterm-fg-" + y.INVERTED_DEFAULT_COLOR);
                            a.appendChild(u)
                        }
                    }
                    return a
        ...
        57 : [function(e, t, i) {
            ...
            var s = function(t) {
                function e() {
                    var e = null !== t && t.apply(this, arguments) || this;
                    return e._currentDevicePixelRatio = window.devicePixelRatio,
                    e
                }
                return n(e, t),
